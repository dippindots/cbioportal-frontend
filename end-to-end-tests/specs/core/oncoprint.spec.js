var assertScreenShotMatch = require("../../lib/testUtils")
  .assertScreenShotMatch;
var assert = require("assert");
var waitForOncoprint = require("./../specUtils").waitForOncoprint;
var goToUrlAndSetLocalStorage = require("./../specUtils")
  .goToUrlAndSetLocalStorage;
var getNthOncoprintTrackOptionsElements = require("./../specUtils")
  .getNthOncoprintTrackOptionsElements;
var getTextInOncoprintLegend = require("./../specUtils")
  .getTextInOncoprintLegend;
var setOncoprintMutationsMenuOpen = require("./../specUtils")
  .setOncoprintMutationsMenuOpen;
var useExternalFrontend = require("./../specUtils").useExternalFrontend;
var waitForNumberOfStudyCheckboxes = require("./../specUtils")
...
describe("oncoprint", function() {
  ...
  describe("heatmap clustering", () => {
    describe("'Cluster Heatmap' button", () => {
      ...
      it("should be active (pressed) if, and only if, the oncoprint is clustered by the profile selected in the dropdown", () => {
        ...
        assert(
          browser
            .getAttribute(clusterButtonSelector, "class")
            .split(/\s+/)
            .indexOf("active") === -1,
          "button not active - 1"
        );
        ...
        browser.execute(function() {
          resultsViewOncoprint.selectHeatmapProfile(1);
        });
        assert(
          browser
            .getAttribute(clusterButtonSelector, "class")
        ...
        browser.execute(function() {
          resultsViewOncoprint.selectHeatmapProfile(0);
        });
        assert(
          browser
            .getAttribute(clusterButtonSelector, "class")
      ...
      it("should return to sort by data when the button is un-clicked", () => {
        ...
        assert(
          browser.isSelected(sortMenuHeatmapRadioSelector),
          "sorted by heatmap clustering"
        );
        ...
        assert(
          !browser.isSelected(sortMenuHeatmapRadioSelector),
          "not sorted by heatmap clustering"
        );
  ...
  describe("mutation annotation", () => {
    ...
    before(() => {
      ...
      mutationColorMenuDropdown =
        "div.oncoprint__controls__mutation_color_menu";

      oncoKbCheckbox =
        mutationColorMenuDropdown + ' input[data-test="annotateOncoKb"]';
      hotspotsCheckbox =
        mutationColorMenuDropdown + ' input[data-test="annotateHotspots"]';
      cbioportalCheckbox =
        mutationColorMenuDropdown +
        ' input[data-test="annotateCBioPortalCount"]';
      cosmicCheckbox =
        mutationColorMenuDropdown + ' input[data-test="annotateCOSMICCount"]';
    });
