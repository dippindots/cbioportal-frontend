...
describe("Results Page", function() {
  ...
  describe("Mutations Tab", () => {
    describe("3D structure visualizer", () => {
      ...
      it("populates PDB info properly", () => {
        ...
        browser.waitUntil(
          () => browser.getText("[data-test=pdbChainInfoText]") !== "LOADING",
          10000
        );
        const text = browser
          ...
          .trim();
        assert.ok(
          text.startsWith("complex structure of brca1 brct with singly")
        );
      });
    });
    ...
    describe("Lollipop Plot Tracks", () => {
      before(() => {
        ...
        browser.waitForExist("[data-test=view3DStructure]", 10000);
        browser.waitForEnabled("[data-test=view3DStructure]", 10000);
        browser.waitForVisible("[data-test=oncogenic-icon-image]", 10000);
      });
      ...
      it("shows tracks when the corresponding dropdown menu options selected", () => {
        ...
        // open OncoKB track
        browser.elements('.//*[text()[contains(.,"OncoKB")]]').value[0].click();
  ...
  describe("oql status banner", function() {
    ...
    it("should not be present in oncoprint tab with simple query", function() {
      assert(
        !browser.isVisible(`${yesBannerSelector}.oncoprint-oql-status-banner`)
      );
      assert(
        !browser.isVisible(`${noBannerSelector}.oncoprint-oql-status-banner`)
      );
    });
    ...
    it("should not be present in mutual exclusivity tab with simple query", function() {
      ...
      browser.pause(500);
      assert(
        !browser.isVisible(`${yesBannerSelector}.mutex-oql-status-banner`)
      );
    ...
    it("should not be present in plots tab with simple query", function() {
      ...
      browser.pause(500);
      assert(
        !browser.isVisible(`${yesBannerSelector}.plots-oql-status-banner`)
      );
    ...
    it("should not be present in mutations tab with simple query", function() {
      ...
      browser.pause(500);
      assert(
        !browser.isVisible(`${yesBannerSelector}.mutations-oql-status-banner`)
      );
      assert(
        !browser.isVisible(`${noBannerSelector}.mutations-oql-status-banner`)
      );
      assert(
        !browser.isVisible(
    ...
    it("should not be present in coexpression tab with simple query", function() {
      ...
      browser.pause(500);
      assert(
        !browser.isVisible(`${yesBannerSelector}.coexp-oql-status-banner`)
      );
    ...
    it("should not be present in enrichments tab with simple query", function() {
      ...
      browser.pause(500);
      assert(
        !browser.isVisible(`${yesBannerSelector}.enrichments-oql-status-banner`)
      );
      assert(
        !browser.isVisible(`${noBannerSelector}.enrichments-oql-status-banner`)
      );
    });
    it("should not be present in survival tab with simple query", function() {
      ...
      browser.pause(500);
      assert(
        !browser.isVisible(`${yesBannerSelector}.survival-oql-status-banner`)
      );
      assert(
        !browser.isVisible(`${noBannerSelector}.survival-oql-status-banner`)
      );
    });
    it("should not be present in download tab with simple query", function() {
      ...
      browser.pause(500);
      assert(
        !browser.isVisible(`${yesBannerSelector}.download-oql-status-banner`)
      );
      assert(
        !browser.isVisible(`${noBannerSelector}.download-oql-status-banner`)
      );
    });
    it("should not be present in expression tab with simple query", function() {
      ...
      assert(
        !browser.isVisible(`${yesBannerSelector}.expression-oql-status-banner`)
      );
      assert(
        !browser.isVisible(`${noBannerSelector}.expression-oql-status-banner`)
      );
    });
