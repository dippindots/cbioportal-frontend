...
describe("alterationCountHelpers", () => {
  describe("#countAlterationOccurences", () => {
    ...
    it("uses alterationSubType to evaluate MRNA direction", () => {
      ...
      assert.equal(
        ret["Hepatobiliary Cancer"].alterationTypeCounts.mrnaExpressionDown,
        1
      );
      assert.equal(
        ret["Hepatobiliary Cancer"].alterationTypeCounts.mrnaExpressionUp,
        1
      );
    });
    ...
    it("uses alterationSubType to evaluate PROT direction", () => {
      ...
      assert.equal(
        ret["Hepatobiliary Cancer"].alterationTypeCounts.protExpressionDown,
        1
      );
      assert.equal(
        ret["Hepatobiliary Cancer"].alterationTypeCounts.protExpressionUp,
        1
      );
    });
  });
