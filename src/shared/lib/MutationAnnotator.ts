...
export function annotateMutations(
  ...
  return mutations.map(mutation =>
    annotateMutation(mutation, indexedVariantAnnotations)
  );
}
...
export function getMutationFromSummary(
  ...
  annotatedMutation.gene.hugoGeneSymbol =
    (!overwrite && annotatedMutation.gene.hugoGeneSymbol) ||
  ...
  annotatedMutation.gene.entrezGeneId =
    annotatedMutation.gene.entrezGeneId || entrezGeneId;
  annotatedMutation.entrezGeneId =
    annotatedMutation.entrezGeneId || entrezGeneId;
