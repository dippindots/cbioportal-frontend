  ...
  describe("makeProfiledInClinicalAttributes", () => {
    ...
    it("creates an attribute for one selected alteration type in which not all samples profiled", () => {
        ...
        [
          {
            ...
            datatype: "STRING",
            description: `Profiled in ${
              molecularProfileIdToMolecularProfile.mutations.name
            }: ${molecularProfileIdToMolecularProfile.mutations.description}`,
            displayName: `Profiled in ${
              molecularProfileIdToMolecularProfile.mutations.name
            }`,
      ...
      assert.deepEqual(
        ...
        [
          {
            clinicalAttributeId: `${SpecialAttribute.ProfiledInPrefix}_${
        ...
        [
          {
            ...
            datatype: "STRING",
            description: `Profiled in ${
              molecularProfileIdToMolecularProfile.linearCna.name
            }: ${molecularProfileIdToMolecularProfile.linearCna.description}`,
            displayName: `Profiled in ${
              molecularProfileIdToMolecularProfile.linearCna.name
            }`,
    ...
    it("creates multiple attributes for each selected alteration type in which not all samples profiled", () => {
      ...
      assert.deepEqual(
        ...
        ),
        {
          ...
          datatype: "STRING",
          description: `Profiled in ${
            molecularProfileIdToMolecularProfile.mrna.name
          }: ${molecularProfileIdToMolecularProfile.mrna.description}`,
          displayName: `Profiled in ${
            molecularProfileIdToMolecularProfile.mrna.name
          }`,
