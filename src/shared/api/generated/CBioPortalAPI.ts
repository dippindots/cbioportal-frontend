...
export default class CBioPortalAPI {
    ...
    getAllGenericAssayDataInMolecularProfileUsingGETURL(parameters: {
        'molecularProfileId': string,
        'sampleListId': string,
        'genericAssayStableId': string,
        'projection' ? : "ID" | "SUMMARY" | "DETAILED" | "META",
        ...
        let queryParameters: any = {};
        let path = '/generic_assay_data/{molecularProfileId}';
        ...
        if (parameters['genericAssayStableId'] !== undefined) {
            queryParameters['genericAssayStableId'] = parameters['genericAssayStableId'];
        }
    ...
    /**
     * Get all generic_assay_id in a molecular profile
     * @method
     * @name CBioPortalAPI#getAllGenericAssayDataInMolecularProfileUsingGET
     * @param {string} molecularProfileId - Molecular Profile ID e.g. study_tcga_pub_gistic
     * @param {string} sampleListId - Sample List ID e.g. study_tcga_pub_all
     * @param {string} genericAssayStableId - Generic Assay Stable ID e.g. 1
     * @param {string} projection - Level of detail of the response
     */
    getAllGenericAssayDataInMolecularProfileUsingGETWithHttpInfo(parameters: {
        'molecularProfileId': string,
        'sampleListId': string,
        'genericAssayStableId': string,
        'projection' ? : "ID" | "SUMMARY" | "DETAILED" | "META",
     ...
     * @param {string} projection - Level of detail of the response
     */
    getAllGenericAssayDataInMolecularProfileUsingGET(parameters: {
            'molecularProfileId': string,
            'sampleListId': string,
            'genericAssayStableId': string,
            'projection' ? : "ID" | "SUMMARY" | "DETAILED" | "META",
        ...
        > {
            return this.getAllGenericAssayDataInMolecularProfileUsingGETWithHttpInfo(parameters).then(function(response: request.Response) {
                return response.body;
            });
        };
    fetchAllGenericAssayDataInMolecularProfileUsingPOSTURL(parameters: {
        'molecularProfileId': string,
    ...
    /**
     * fetch all generic_assay_data in a molecular profile
     * @method
     * @name CBioPortalAPI#fetchAllGenericAssayDataInMolecularProfileUsingPOST
     * @param {string} molecularProfileId - Molecular Profile ID e.g. study_tcga_pub_gistic
     * @param {} genericAssayDataFilter - List of Sample IDs/Sample List ID and Entrez Gene IDs
     * @param {string} projection - Level of detail of the response
     */
    fetchAllGenericAssayDataInMolecularProfileUsingPOSTWithHttpInfo(parameters: {
        'molecularProfileId': string,
        'genericAssayDataFilter': GenericAssayDataFilter,
        'projection' ? : "ID" | "SUMMARY" | "DETAILED" | "META",
        $queryParameters ? : any,
     ...
     * @param {string} projection - Level of detail of the response
     */
    fetchAllGenericAssayDataInMolecularProfileUsingPOST(parameters: {
            'molecularProfileId': string,
            'genericAssayDataFilter': GenericAssayDataFilter,
            'projection' ? : "ID" | "SUMMARY" | "DETAILED" | "META",
            $queryParameters ? : any,
        ...
        > {
            return this.fetchAllGenericAssayDataInMolecularProfileUsingPOSTWithHttpInfo(parameters).then(function(response: request.Response) {
                return response.body;
            });
        };
    fetchAllGenericAssayMetaDataUsingPOSTURL(parameters: {
     ...
     * @method
     * @name CBioPortalAPI#fetchAllGenericAssayMetaDataUsingPOST
     * @param {} stableIds - stableIds
     */
    fetchAllGenericAssayMetaDataUsingPOSTWithHttpInfo(parameters: {
        'stableIds': Array < string > ,
        $queryParameters ? : any,
        $domain ? : string
    }): Promise < request.Response > {
        ...
        return new Promise(function(resolve, reject) {
            ...
            if (parameters['stableIds'] !== undefined) {
                body = parameters['stableIds'];
            }

            if (parameters['stableIds'] === undefined) {
                reject(new Error('Missing required  parameter: stableIds'));
                return;
            }
     ...
     * @param {} stableIds - stableIds
     */
    fetchAllGenericAssayMetaDataUsingPOST(parameters: {
            'stableIds': Array < string > ,
            $queryParameters ? : any,
            $domain ? : string
        }): Promise < Array < GenericAssayMeta >
        > {
            return this.fetchAllGenericAssayMetaDataUsingPOSTWithHttpInfo(parameters).then(function(response: request.Response) {
                return response.body;
            });
        };
    getAllGenericAssayMetaDataUsingGETURL(parameters: {
        'stableId': string,
        $queryParameters ? : any
    }): string {
        let queryParameters: any = {};
        let path = '/generic_assay_meta/{stableId}';

        path = path.replace('{stableId}', parameters['stableId'] + '');
    ...
    /**
     * Get all meta data in generic-assay by stable id
     * @method
     * @name CBioPortalAPI#getAllGenericAssayMetaDataUsingGET
     * @param {string} stableId - Stable ID e.g. 1
     */
    getAllGenericAssayMetaDataUsingGETWithHttpInfo(parameters: {
        'stableId': string,
        $queryParameters ? : any,
        $domain ? : string
    }): Promise < request.Response > {
        ...
        return new Promise(function(resolve, reject) {
            ...
            if (parameters['stableId'] === undefined) {
                reject(new Error('Missing required  parameter: stableId'));
                return;
            }
     ...
     * @param {string} stableId - Stable ID e.g. 1
     */
    getAllGenericAssayMetaDataUsingGET(parameters: {
        'stableId': string,
        $queryParameters ? : any,
        $domain ? : string
    }): Promise < GenericAssayMeta > {
        return this.getAllGenericAssayMetaDataUsingGETWithHttpInfo(parameters).then(function(response: request.Response) {
            return response.body;
        });
    };
