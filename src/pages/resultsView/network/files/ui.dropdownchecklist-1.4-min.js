(function(a) {
  a.widget("ui.dropdownchecklist", {
    ...
    _handleKeyboard: function(d) {
      ...
      if (!b.dropWrapper.isOpen && b._isDropDownKeyShortcut(d, c)) {
        ...
        if (b.dropWrapper.isOpen && b._isDropDownCloseKey(d, c)) {
          ...
          if (
            b.dropWrapper.isOpen &&
            d.target.type == "checkbox" &&
            (c == a.ui.keyCode.DOWN || c == a.ui.keyCode.UP)
          ) {
            d.stopImmediatePropagation();
    ...
    _appendControl: function() {
      ...
      b.css({ display: "inline-block", cursor: "default", overflow: "hidden" });
      var f = c.attr("id");
      if (f == null || f == "") {
      ...
      if (k.icon != null) {
        ...
        g.addClass("ui-icon");
        g.addClass(
          k.icon.toOpen != null ? k.icon.toOpen : "ui-icon-triangle-1-e"
        );
        g.css({ float: i });
        h.append(g);
      }
    ...
    _createCloseItem: function(e) {
      ...
      d.css({ "white-space": "nowrap", "text-align": "right" });
      var c = a("<span/>");
      c.addClass("ui-dropdownchecklist-text");
      c.css({ cursor: "default" });
      c.html(e);
    ...
    _toggleDropContainer: function(e) {
      ...
      var d = function(f) {
        if (f != null && f.dropWrapper.isOpen) {
          ...
          if (j.length > 0) {
            j.removeClass(
              h.icon.toClose != null ? h.icon.toClose : "ui-icon-triangle-1-s"
            );
            j.addClass(
              h.icon.toOpen != null ? h.icon.toOpen : "ui-icon-triangle-1-e"
            );
          }
        ...
        if (!n.dropWrapper.isOpen) {
          ...
          if (g.positionHow == null || g.positionHow == "absolute") {
            n.dropWrapper.css({
              position: "absolute",
              top:
                n.controlWrapper.position().top +
                n.controlWrapper.outerHeight() +
                "px",
          ...
          if (h.length > 0) {
            h.removeClass(
              g.icon.toOpen != null ? g.icon.toOpen : "ui-icon-triangle-1-e"
            );
            h.addClass(
              g.icon.toClose != null ? g.icon.toClose : "ui-icon-triangle-1-s"
            );
          }
