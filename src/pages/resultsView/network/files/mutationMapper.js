...
var DataTableUtil = (function() {
  ...
  function buildColumnNameMap(columns) {
    ...
    _.each(_.pairs(columns), function(pair, index) {
      ...
      if (options.sTitle != null && options.sTitle.length > 0) {
...
var MutationViewsUtil = (function() {
  ...
  var _mutationStyleMap = {
    ...
    other: { style: "other_mutation", mainType: "other", priority: 11 }
  };
  ...
  var _cnaMap = {
    ...
    "-1": {
      label: "ShallowDel",
      style: "cna-hetloss",
      tooltip: "Shallow deletion"
    },
    "0": {
      label: "Diploid",
      style: "cna-diploid",
      tooltip: "Diploid / normal"
    },
    "1": { label: "Gain", style: "cna-gain", tooltip: "Low-level gain" },
    "2": {
      label: "AMP",
      style: "cna-amp",
      tooltip: "High-level amplification"
    },
    unknown: {
      label: "NA",
      style: "cna-unknown",
      tooltip: "CNA data is not available for this gene"
    }
  };
    ...
    $(tabs).bind("tabsactivate", function(event, ui) {
      ...
      if (
        ui.newTab
          .text()
          .trim()
          .toLowerCase() == tabName.toLowerCase()
      ) {
  ...
  function defaultTableTooltipOpts() {
    return {
      ...
      style: {
        classes: "mutation-details-tooltip qtip-shadow qtip-light qtip-rounded"
      },
  ...
  function renderTablePlaceholder(imageLocation) {
    imageLocation = imageLocation || "files/ajax-loader.gif";
    ...
    var templateFn = BackboneTemplateCache.getTemplateFn(
      "mutation_table_placeholder_template"
    );
...
var MutationDetailsTableFormatter = (function() {
  ...
  function getCaseId(caseId) {
    ...
    if (caseId != null && caseId.length > maxLength + 2) {
  ...
  function getProteinChange(mutation) {
    ...
    if (
      mutation.get("aminoAcidChange") != null &&
      mutation.get("aminoAcidChange").length > 0 &&
      mutation.get("aminoAcidChange") !== "NA" &&
      mutation.get("cancerStudyShort") != null &&
      mutation
        .get("cancerStudyShort")
        .toLowerCase()
        .indexOf("msk-impact") != -1 &&
      isDifferentProteinChange(
        mutation.get("proteinChange"),
        mutation.get("aminoAcidChange")
      )
    ) {
      additionalTip =
        "The original annotation file indicates a different value: <b>" +
        normalizeProteinChange(mutation.get("aminoAcidChange")) +
        "</b>";
    }
    ...
    return {
      text: normalizeProteinChange(mutation.get("proteinChange")),
      style: style,
      tip: tip,
  ...
  function isDifferentProteinChange(proteinChange, aminoAcidChange) {
    ...
    if (aminoAcidChange !== proteinChange) {
      ...
      if (
        locationMatch1 &&
        locationMatch2 &&
        locationMatch1.length > 0 &&
        locationMatch2.length > 0 &&
        ...
        proteinMatch1 &&
        proteinMatch2 &&
        proteinMatch1.length > 0 &&
        proteinMatch2.length > 0 &&
        proteinMatch1[0] !== "X" &&
        proteinMatch2[0] !== "X" &&
        ...
        proteinMatch1 &&
        proteinMatch2 &&
        proteinMatch1.length > 1 &&
        proteinMatch2.length > 1 &&
  ...
  function normalizeProteinChange(proteinChange) {
    ...
    if (proteinChange.indexOf(prefix) != -1) {
      proteinChange = proteinChange.substr(
        proteinChange.indexOf(prefix) + prefix.length
      );
    }
  ...
  function getTumorType(mutation) {
    ...
    return { text: mutation.get("tumorType"), style: style, tip: tip };
  }
  ...
  function getCbioPortal(frequency) {
    ...
    return { style: style, frequency: text };
  }
...
var PileupUtil = (function() {
  ...
  function initPileup(mutations, location) {
    ...
    pileup.stats = _.chain(mutations[location])
      .groupBy(function(mut) {
        return mut.get("cancerType");
      })
  ...
  function generateLabel(mutations) {
    ...
    _.each(mutations, function(mutation) {
      if (
        mutation.get("proteinChange") != null &&
        mutation.get("proteinChange").length > 0
      ) {
        mutationSet[mutation.get("proteinChange")] = mutation.get(
          "proteinChange"
        );
      }
    });
...
var DataProxyUtil = (function() {
    ...
    _.each(_.keys(options).sort(), function(proxy) {
      ...
      if (proxy == "pdbProxy") {
        instance = initDataProxy(proxyOpts, function(proxyOpts) {
          ...
          if (mutationProxy != null && mutationProxy.hasData()) {
  ...
  function initDataProxy(proxyOpts, preProcessFn) {
    ...
    if (instance == null) {
      ...
      if (preProcessFn != null && _.isFunction(preProcessFn)) {
...
function JmolScriptGenerator() {
  ...
  function rainbowColor(chainId) {
    ...
    return (
      'color atoms property atomNo "roygb" ' +
      "range " +
      rangeMin +
      " " +
      rangeMax +
  ...
  function scriptPosition(position) {
    ...
    var posStr = startPdbPos + insertionStr(position.start.insertion);

    if (endPdbPos > startPdbPos) {
      posStr += "-" + endPdbPos + insertionStr(position.end.insertion);
    }
...
function MergedAlignmentSegmentor(mergedAlignment) {
  ...
  function getNextSegment() {
    ...
    if (isSpecialSymbol(symbol)) {
      ...
      while (str[end] == symbol && end <= str.length) {
        end++;
      }
    } else {
      segment.type = "regular";

      while (!isSpecialSymbol(str[end]) && end <= str.length) {
        end++;
      }
    }
...
function Mol3DScriptGenerator() {
  ...
  function scriptPosition(position) {
    ...
    if (residues.length > 1 && position.end.insertion) {
...
function MolScriptGenerator() {
   ...
   * @param chain             a PdbChainModel instance
   */
  this.generateSideChainScript = function(
    scriptPositions,
    displaySideChain,
    options,
    chain
  ...
  this.generateHighlightScript = function(positions, color, options, chain) {
    ...
    if (!_.isEmpty(positions)) {
      ...
      script = script.concat(
        self.highlightScript(scriptPositions, color, options, chain)
      );
    }
...
var MutationDetailsUtil = function(mutations) {
    ...
    for (var i = 0; i < cases.length; i++) {
      ...
      if (mutations != null) {
        ...
        for (var j = 0; j < mutations.length; j++) {
          ...
          if (
            mutations[j].get("geneSymbol").toLowerCase() != gene.toLowerCase()
          ) {
            continue;
          }

          if (
            mutations[j].get("mutationStatus") &&
  ...
  this.containsIgvLink = function(gene) {
    return this._contains(gene, function(mutation) {
      return mutation.get("igvLink") && mutation.get("igvLink") != "NA";
    });
  };
  ...
  this.containsCaseId = function(gene) {
    return this._contains(gene, function(mutation) {
      return mutation.get("caseId") && mutation.get("caseId") != "NA";
    });
  };

  this.containsChr = function(gene) {
    return this._contains(gene, function(mutation) {
      return mutation.get("chr") && mutation.get("chr") != "NA";
    });
  };

  this.containsStartPos = function(gene) {
    return this._contains(gene, function(mutation) {
      return mutation.get("startPos") && mutation.get("startPos") > 0;
    });
  };
  ...
  this.containsVarAllele = function(gene) {
    return this._contains(gene, function(mutation) {
      return (
        mutation.get("variantAllele") && mutation.get("variantAllele") != "NA"
      );
    });
  };
  ...
  this.containsEndPos = function(gene) {
    return this._contains(gene, function(mutation) {
      return mutation.get("endPos") && mutation.get("endPos") > 0;
    });
  };
  ...
  this.containsMutationType = function(gene) {
    return this._contains(gene, function(mutation) {
      return (
        mutation.get("mutationType") && mutation.get("mutationType") != "NA"
      );
    });
  };
  ...
  this.containsMutationCount = function(gene) {
    return this._contains(gene, function(mutation) {
      return mutation.get("mutationCount") && mutation.get("mutationCount") > 0;
    });
  };

  this.containsKeyword = function(gene) {
    return this._contains(gene, function(mutation) {
      return mutation.get("keyword") && mutation.get("keyword") != "NA";
    });
  };
  ...
  this.dataFieldCount = function(gene, dataField, excludeList) {
    ...
    if (mutations != null) {
      for (var i = 0; i < mutations.length; i++) {
        ...
        if (value && !_.contains(excludeList, value)) {
...
function MutationInputParser() {
  ...
  function parseLine(line, indexMap) {
    ...
    attributes.variantKey = VariantAnnotationUtil.generateVariantKey(
      attributes
    );
  ...
  function getGeneList() {
    ...
    if (_geneList == null) {
      ...
      _data.each(function(mutation, idx) {
        if (
          mutation.get("geneSymbol") != null &&
          mutation.get("geneSymbol").length > 0
        ) {
          geneSet[mutation.get("geneSymbol").toUpperCase()] = mutation
            .get("geneSymbol")
            .toUpperCase();
        }
      });
...
var PdbDataUtil = (function() {
  ...
  function processPdbData(data) {
    ...
    _.each(_.keys(pdbMap), function(pdbId) {
      ...
      _.each(_.keys(pdbMap[pdbId]), function(chain) {
        var chainModel = new PdbChainModel({
          chainId: chain,
      ...
      var pdbModel = new PdbModel({ pdbId: pdbId, chains: chains });
  ...
  function getOrganism(pdbInfo, chainId) {
    ...
    _.find(pdbInfo.compound, function(mol) {
      if (
        ...
        // chain is associated with this mol,
        // get the organism info from the source
        organism = pdbInfo.source[mol.mol_id].organism_scientific || organism;
        return mol;
      }
    });
  ...
  function mutationToPdb(mutation, rowData) {
    ...
    for (var i = 0; i < rowData.length && !pdbMatch; i++) {
      var allocation = rowData[i];

      for (var j = 0; j < allocation.length && !pdbMatch; j++) {
        ...
        var rangeWithin =
          location >= alignment.uniprotFrom && location <= alignment.uniprotTo;

        // check for match condition
        if (rangeWithin && alignmentMatch(alignment, location)) {
          pdbMatch = { pdbId: datum.pdbId, chainId: datum.chain.chainId };
  ...
  function addPdbMatchData(mutationData, pdbRowData) {
    ...
    _.each(mutationData, function(mutation, idx) {
      if (mutation == null) {
        console.log(
          "warning [processMutationData]: mutation (at index %d) is null.",
          idx
        );
        return;
      }
  ...
  function allocateChainRows(pdbColl) {
    ...
    if (rows.length > 0) {
      rows[0].sort(function(a, b) {
        return (
          b.chain.mergedAlignment.mergedString.length -
  ...
  function overlaps(chain1, chain2) {
    ...
    if (
      chain1.mergedAlignment.uniprotFrom >= chain2.mergedAlignment.uniprotTo ||
  ...
  function sortChains(chains, comparators) {
    ...
    chains.sort(function(a, b) {
      ...
      for (var i = 0; i < comparators.length && result == 0; i++) {
  ...
  function compareIdentity(a, b) {
    ...
    return b.chain.mergedAlignment.identity - a.chain.mergedAlignment.identity;
  }

  function compareIdentityPerc(a, b) {
    // higher value should comes first
    return (
      b.chain.mergedAlignment.identityPerc -
  ...
  function compareEValue(a, b) {
    ...
    return (
      getMinValue(a.chain.alignments, "eValue") -
  ...
  function compareIdentP(a, b) {
    ...
    return (
      getMinValue(b.chain.alignments, "identityPerc") -
...
var VariantAnnotationUtil = (function() {
  ...
  function generateVariantKey(mutation) {
    ...
    if (referenceAllele != null && referenceAllele === variantAllele) {
      console.log(
        "[VariantAnnotationUtil.generateVariantKey] " +
          "Warning: Reference allele (" +
          referenceAllele +
          ") for " +
          chr +
          ":" +
    ...
    if (chr && startPos && referenceAllele && variantAllele) {
      ...
      if (endPos) {
        ...
        if (referenceAllele === "-" || referenceAllele.length === 0) {
        ...
        else if (variantAllele === "-" || variantAllele.length === 0) {
...
var VepParser = (function() {
  ...
  function parseJSON(annotation) {
    ...
    var canonicalTranscript = getCanonicalTranscript(
      transcripts,
      mostSevereConsequence
    );

    if (canonicalTranscript && vepData.transcripts[canonicalTranscript.index]) {
      vepData.canonicalTranscript =
  ...
  function parseTranscript(
    ...
    if (consequenceTerms != null && consequenceTerms.length > 0) {
    ...
    if (refseqIds != null && refseqIds.length > 0) {
    ...
    if (
      mostSevereConsequence === "splice_acceptor_variant" ||
   ...
   */
  function transcriptWithMostSevereConsequence(
    transcripts,
    mostSevereConsequence
  ) {
...
var PdbAlignmentModel = Backbone.Model.extend({
  initialize: function(attributes) {
    ...
    this.alignmentString =
      attributes.alignmentString || PdbDataUtil.alignmentString(attributes);
...
var CosmicTipView = Backbone.View.extend({
      ...
      aoColumnDefs: [
        {
          mRender: function(data, type, full) {
            ...
            return (
              '<a href="http://cancer.sanger.ac.uk/cosmic/mutation/overview?id=' +
              data +
              '">' +
              data +
              "</a>"
  ...
  compileTemplate: function() {
    ...
    var templateFn = BackboneTemplateCache.getTemplateFn(
      "mutation_details_cosmic_tip_template"
    );
...
var LollipopTipStatsView = Backbone.View.extend({
  ...
  render: function() {
    var templateFn = BackboneTemplateCache.getTemplateFn(
      "mutation_details_lollipop_tip_stats_template"
    );
...
var LollipopTipView = Backbone.View.extend({
  ...
  compileTemplate: function() {
    ...
    // compile the template using underscore
    var templateFn = BackboneTemplateCache.getTemplateFn(
      "mutation_details_lollipop_tip_template"
    );
    var compiledEl = $(templateFn(variables));

    var statsEl = compiledEl.find(".lollipop-stats");
    if (this.showStats) {
      new LollipopTipStatsView({
        el: statsEl,
        model: thatModel.stats
      }).render();
...
var MainMutationView = Backbone.View.extend({
  initialize: function(options) {
    var defaultOpts = {
      config: {
        loaderImage: "files/ajax-loader.gif"
      }
    };
  ...
  _init3dView: function(gene, uniprotId, pdbProxy, mut3dVisView) {
    ...
    var view3d = new Mutation3dView({
      el: target,
      model: { uniprotId: uniprotId, geneSymbol: gene, pdbProxy: pdbProxy }
    });
  ...
  initMutationDiagramView: function(options, sequence) {
    ...
    if (!self.diagramView) {
      console.log(
        "Error initializing mutation diagram: %s",
        self.model.geneSymbol
      );
    } else {
   ...
   */
  _initMutationDiagramView: function(
    gene,
    mutationData,
    sequenceData,
    dataProxies,
  ...
  initMutationTableView: function(options) {
    ...
    self.tableView = self._initMutationTableView(
      self.model.geneSymbol,
      self.model.mutationData,
      self.model.dataProxies,
    ...
    if (!self.tableView) {
      console.log(
        "Error initializing mutation table: %s",
        self.model.geneSymbol
      );
    }
   ...
   */
  _initMutationTableView: function(
    gene,
    mutationData,
    dataProxies,
    dataManager,
    ...
    var formatButton = function(hasData) {
      if (hasData) {
        ...
        var qtipOpts = {
          ...
          show: { event: "mouseover" },
          style: {
            classes: "qtip-light qtip-rounded qtip-shadow cc-ui-tooltip"
          },
          position: {
            my: "bottom center",
            at: "top center",
...
var Mutation3dVisInfoView = Backbone.View.extend({
  ...
  format: function() {
    ...
    if (pdbInfo == null || pdbInfo.length == 0) {
    ...
    if (molInfo == null || molInfo.length == 0) {
...
var Mutation3dVisView = Backbone.View.extend({
  ...
  format: function() {
    ...
    var helpTemplateFn = BackboneTemplateCache.getTemplateFn(
      "3Dmol_basic_interaction"
    );
    ...
    container3d
      .resizable({
        alsoResize:
          ".mutation-3d-vis-container,.mutation-3d-vis-container div:eq(0)",
        ...
        start: function(event, ui) {
          ...
          container3d
            .find(".mutation-3d-vis-help-content")
            .css("width", "auto");
  ...
  _initButtons: function() {
    ...
    pymolDownload.click(function(event) {
      ...
      var filename =
        self.$el
          .find(".mutation-3d-pdb-id")
          .text()
          .trim() +
        "_" +
        self.$el
          .find(".mutation-3d-chain-id")
          .text()
          .trim() +
        ".pml";
  ...
  updateView: function(geneSymbol, pdbId, chain) {
    ...
    var infoCallback = function(pdbInfo) {
      ...
      var infoView = new Mutation3dVisInfoView({
        el: self.$el.find(".mutation-3d-info"),
        model: model
      });
      infoView.render();
  ...
  refreshView: function(pdbId, chain) {
    ...
    if (
      ...
      self.dispatcher.trigger(MutationDetailsEvents.VIEW_3D_STRUCTURE_RELOADED);
    }
  ...
  _initMutationColorInfo: function() {
    ...
    var templateFn = BackboneTemplateCache.getTemplateFn(
      "mutation_3d_type_color_tip_template"
    );
  ...
  _initProteinColorInfo: function() {
    ...
    var templateFn = BackboneTemplateCache.getTemplateFn(
      "mutation_3d_structure_color_tip_template"
    );
    var content = templateFn({});
    var options = self._generateTooltipOpts(content);
  ...
  _initSideChainInfo: function() {
    ...
    var templateFn = BackboneTemplateCache.getTemplateFn(
      "mutation_3d_side_chain_tip_template"
    );
    var content = templateFn({});
  ...
  _initHideNonProteinInfo: function() {
    ...
    var templateFn = BackboneTemplateCache.getTemplateFn(
      "mutation_3d_non_protein_tip_template"
    );
    var content = templateFn({});
  ...
  resetPanelPosition: function() {
    ...
    container3d.css({
      left: "",
      position: "",
      top: self.options.config.border.top
    });
  },
  /**
  ...
  hideView: function() {
    ...
    // trigger corresponding event
    self.dispatcher.trigger(MutationDetailsEvents.VIEW_3D_PANEL_CLOSED);
  },
  /**
...
var MutationCustomizePanelView = Backbone.View.extend({
  ...
  render: function() {
    ...
    // template vars
    var variables = { minY: 2, maxY: diagram.getInitialMaxY() };

    // compile the template using underscore
    var templateFn = BackboneTemplateCache.getTemplateFn(
      "mutation_customize_panel_template"
    );
    var template = templateFn(variables);
  ...
  format: function() {
    ...
    yAxisInput.keypress(function(event) {
      ...
      if (event.keyCode == enterCode) {
        ...
        if (isNaN(value) || value > diagram.getThreshold()) {
          value = diagram.getThreshold();
        } else if (input < 2) {
          value = 2;
        }
...
var MutationDetailsTableView = Backbone.View.extend({
  ...
  render: function() {
    ...
    // compile the template using underscore
    var templateFn = BackboneTemplateCache.getTemplateFn(
      "mutation_details_table_template"
    );
  ...
  clearSearchBox: function() {
    var self = this;
    var searchBox = self.$el.find(
      ".mutation_datatables_filter input[type=search]"
    );
    searchBox.val("");
  },
  /**
...
var MutationDetailsView = Backbone.View.extend({
  ...
  render: function() {
    ...
    // compile the template using underscore
    var templateFn = BackboneTemplateCache.getTemplateFn(
      self.options.config.coreTemplate
    );
    var template = templateFn(variables);
  ...
  format: function() {
    ...
    if (self.model.mutationProxy.hasData()) {
      ...
      self.$el
        .find(".mutation-details-tabs-ref")
        .tipTip({
  ...
  init3dPanel: function() {
    ...
    self.dispatcher.trigger(MutationDetailsEvents.VIS_3D_PANEL_INIT);
  ...
  _generateContent: function() {
    ...
    _.each(self.model.mutationProxy.getGeneList(), function(gene, idx) {
      var templateFn = BackboneTemplateCache.getTemplateFn(
        self.options.config.mainContentTemplate
      );
      ...
      templateFn = BackboneTemplateCache.getTemplateFn(
        self.options.config.listContentTemplate
      );
  ...
  _initDefaultView: function() {
    ...
    contentSelector.bind("tabscreate", function(event, ui) {
      ...
      // trigger corresponding event
      self.dispatcher.trigger(MutationDetailsEvents.GENE_TABS_CREATED);
    });
    ...
    contentSelector.bind("tabsactivate", function(event, ui) {
      ...
      // trigger corresponding event
      self.dispatcher.trigger(MutationDetailsEvents.GENE_TAB_SELECTED, gene);
    });
  }
});
...
var MutationDiagramView = Backbone.View.extend({
  ...
  render: function() {
    ...
    // compile the template using underscore
    var templateFn = BackboneTemplateCache.getTemplateFn(
      "mutation_diagram_view_template"
    );
    var template = templateFn(variables);
  ...
  _initMutationDiagram: function(
    ...
    // the sequence data
    if (sequenceData["length"] == "" || parseInt(sequenceData["length"]) <= 0) {
...
var MutationInfoPanelView = Backbone.View.extend({
  ...
  updateView: function(mutations) {
    ...
    countByType = _.extend(
      self._generateZeroCountMap(self.initialMapByType),
      countByType
    );
    ...
    _.each(keys, function(mutationType) {
      var templateFn = BackboneTemplateCache.getTemplateFn(
        "mutation_info_panel_type_template"
      );
...
var MutationSummaryView = Backbone.View.extend({
  ...
  render: function() {
    ...
    self.model.clinicalProxy.getPatientData(self.model.sampleArray, function(
      data
    ) {
      if (!data) {
      ...
      // compile the template using underscore
      var templateFn = BackboneTemplateCache.getTemplateFn(
        "mutation_summary_view_template"
      );
      var template = templateFn(variables);
...
var PancanMutationHistTipView = Backbone.View.extend({
  render: function() {
    ...
    // render view
    var templateFn = BackboneTemplateCache.getTemplateFn(
      "pancan_mutation_hist_tip_template"
    );
  ...
  format: function() {
    ...
    // init the histogram
    var histogram = PancanMutationHistogram(
      byProteinPosData,
      byHugoData,
      metaData,
      container[0],
...
var PdbChainTipView = Backbone.View.extend({
  ...
  compileTemplate: function() {
    ...
    // compile the template using underscore
    var templateFn = BackboneTemplateCache.getTemplateFn(
      "mutation_details_pdb_chain_tip_template"
    );
    return templateFn(variables);
  }
});
...
var PdbPanelView = Backbone.View.extend({
  ...
  _initPdbPanel: function() {
    ...
    var options = {
      el: self.$el.find(".mutation-pdb-panel-container"),
      maxHeight: 200
    };
    var xScale = null;
...
var PdbTableView = Backbone.View.extend({
  ...
  scrollToSelected: function() {
    ...
    // TODO make scroll parameters customizable?
    container.scrollTo($(selected), { axis: "y", duration: 800 });
  },
  /**
   * Initializes the PDB chain table.
   *
  ...
  _initPdbTable: function(callback) {
    ...
    self._generateRowData(table.getColumnOptions(), pdbColl, pdbProxy, function(
      rowData
    ) {
      // init table with the row data
      table.renderTable(rowData);
...
var RegionTipView = Backbone.View.extend({
  ...
  compileTemplate: function() {
    ...
    // compile the template using underscore
    var templateFn = BackboneTemplateCache.getTemplateFn(
      "mutation_details_region_tip_template"
    );
    return templateFn(variables);
  }
});
  ...
  function getPatientData(samples, callback) {
    ...
    function makePatientData() {
      ...
      var args = {
        ...
        attribute_ids: ["12_245_PARTC_CONSENTED"],
  ...
  var _defaultOpts = {
    dataFn: {
      ...
      cBioPortal: function(dataProxies, params, callback) {
        ...
        var mutationUtil =
          params.mutationUtil || params.mutationTable.getMutationUtil();
        var mutations = params.mutations || params.mutationTable.getMutations();

        // get the pancan data and update the data & display values
        pancanProxy.getPancanData(
          { cmd: "byProteinPos" },
          mutationUtil,
          function(dataByPos) {
            pancanProxy.getPancanData(
              ...
              function(dataByGeneSymbol) {
                ...
                _.each(mutations, function(ele, i) {
                  ...
                  if (proteinPosStart > 0) {
                    var value =
                      PancanMutationDataUtil.countByKey(
                        frequencies,
                        proteinPosStart
                      ) || 0;
...
function MutationDataProxy(options) {
  ...
  var _geneList = _options.geneList
    .trim()
    .split(/\s+/)
    .sort();
  ...
  function getMutationData(geneList, callback) {
    ...
    // we need to retrieve missing data (lazy init)
      ...
      var paramsPromise =
        _options.paramsPromise || new $.Deferred().resolve(_options.params);
      ...
      paramsPromise.then(function(servletParams) {
        ...
        if (genesToQuery.length > 0) {
          ...
          var ajaxOpts = {
            ...
            error: function() {
              console.log(
                "[MutationDataProxy.getMutationData] " +
                  "error retrieving mutation data for genetic profiles: " +
                  servletParams.geneticProfiles
              );
              process([]);
            },
            dataType: "json"
...
function PancanMutationDataProxy(options) {
  ...
  function getPancanData(servletParams, mutationUtil, callback) {
    ...
    if (cmd == null) {
      ...
      // if no query params (genes) provided, use all available
      var proteinChanges =
        q == null ? mutationUtil.getAllProteinChanges() : q.split(",");
      getData(
        cmd,
        proteinChanges,
        _cacheByProteinChange,
        ["protein_change"],
        callback
      );
    } else if (cmd == "byProteinPos") {
      // if no query params (genes) provided, use all available
      var proteinPositions =
        q == null ? mutationUtil.getAllProteinPosStarts() : q.split(",");
      getData(
        cmd,
        proteinPositions,
        _cacheByProteinPosition,
        ["hugo", "protein_pos_start"],
        callback
      );
    } else {
      // invalid command
  ...
  function getData(cmd, keys, cache, fields, callback) {
    ...
    if (toQuery.length > 0 && !self.isFullInit()) {
...
function PdbDataProxy(options) {
  ...
  function getPositionMap(gene, chain, callbackFn) {
    ...
    var processData = function(data) {
      ...
      if (positionData != null && _.size(positionData) > 0) {
        ...
        for (var i = 0; i < mutations.length; i++) {
          ...
          if (type != null && type.toLowerCase() === "in_frame_del") {
  ...
  function getPdbData(uniprotId, callback) {
    ...
    if (_pdbDataCache[uniprotId] == undefined) {
      ...
      if (_options.subService && _options.subService.alignmentByUniprot) {
  ...
  function getPdbRowData(uniprotId, callback) {
    ...
    if (!self.isFullInit() && _pdbRowDataCache[uniprotId] == undefined) {
  ...
  function getPdbDataSummary(uniprotId, callback) {
    // retrieve data from the server if not cached
    if (!self.isFullInit() && _pdbDataSummaryCache[uniprotId] == undefined) {
      // process & cache the raw data
      var processData = function(data) {
        var summaryData = data;

        if (_.isArray(summaryData) && _.size(summaryData) > 0) {
      ...
      if (_options.subService && _options.subService.summary) {
  ...
  function getPdbInfo(pdbIdList, callback) {
    ...
    if (pdbToQuery.length > 0) {
      ...
      if (_options.subService && _options.subService.header) {
...
function VariantAnnotationDataProxy(options) {
    ...
    // we need to retrieve missing data (lazy init)
      ...
      if (variantsToQuery.length > 0) {
        ...
        var ajaxOpts = {
          ...
          error: function() {
            console.log(
              "[VariantDataProxy.getAnnotationData] " +
  ...
  function processAnnotationJSON(variant) {
    if (_.isString(variant.annotationJSON)) {
      ...
      if (_.isArray(annotation) && annotation.length > 0) {
...
function AdvancedDataTable(options) {
  ...
  self.renderTable = function(rows) {
    ...
    var visibilityMap = DataTableUtil.buildColumnVisMap(
      columnOrder,
      self._visibilityValue
    );
    self._visiblityMap = visibilityMap;

    // build a map to determine searchable columns
    var searchMap = DataTableUtil.buildColumnSearchMap(
      columnOrder,
      self._searchValue
    );

    // determine hidden and excluded columns
    var hiddenCols = DataTableUtil.getHiddenColumns(
      columnOrder,
      indexMap,
      visibilityMap
    );
    var excludedCols = DataTableUtil.getExcludedColumns(
      columnOrder,
      indexMap,
      visibilityMap
    );
    ...
    var nonSearchableCols = DataTableUtil.getNonSearchableColumns(
      columnOrder,
      indexMap,
      searchMap
    );
   ...
   */
  self._initDataTableOpts = function(
    tableSelector,
    rows,
    columnOpts,
    nameMap,
  ...
  self._initDataTable = function(
    ...
    var tableOpts = self._initDataTableOpts(
      tableSelector,
      rows,
      columnOpts,
      nameMap,
    ...
    var mData = DataTableUtil.getColumnData(
      indexMap,
...
function Mutation3dVis(name, options) {
  ...
  var defaultOpts = {
    ...
    structureColors: {
      // default colors for special structures
      alphaHelix: "#FFA500",
      betaSheet: "#0000FF",
      loop: "#DDDDDD"
  ...
  function updateContainer(container) {
    ...
    appContainer.css(
      "height",
      _options.appOptions.height + _options.containerPadding
    );
  ...
  function reapplyStyle() {
    ...
    var script = _scriptGen.generateVisualStyleScript(
      _selection,
      _chain,
      _options
    );
  ...
  function minimize() {
    // minimize container
    if (_container != null) {
      _container.css({ overflow: "hidden", height: _options.minimizedHeight });
      _minimized = true;
    }
  }
  ...
  function addGlowEffect() {
    ...
    gradient.setSpectrum(
      _options.highlightGradient[0].replace("#", ""),
  ...
  function generatePymolScript() {
    ...
    script = script.concat(
      scriptGen.generateVisualStyleScript(_selection, _chain, _options)
    );
...
function MutationDetailsTable(
  ...
  var _defaultOpts = {
    ...
    // [data table options]: sType, sClass, sWidth, asSorting, ...
    columns: {
      datum: { sTitle: "datum", tip: "" },
      mutationId: {
        sTitle: "Mutation ID",
        tip: "Mutation ID",
        sType: "string"
      },
      mutationSid: { sTitle: "Mutation SID", tip: "", sType: "string" },
      caseId: { sTitle: "Sample ID", tip: "Sample ID", sType: "string" },
      cancerStudy: {
        sTitle: "Cancer Study",
        tip: "Cancer Study",
        sType: "string"
      },
      tumorType: { sTitle: "Cancer Type", tip: "Cancer Type", sType: "string" },
      proteinChange: {
        sTitle: "AA change",
        tip: "Protein Change",
        sType: "numeric"
      ...
      mutationAssessor: {
        sTitle: "Mutation Assessor",
        tip:
          "Predicted Functional Impact Score (via Mutation Assessor) for missense mutations",
        sType: "numeric",
        sClass: "center-align-td",
        asSorting: ["desc", "asc"],
        sWidth: "2%"
      ...
      chr: { sTitle: "Chr", tip: "Chromosome", sType: "string" },
      startPos: {
        sTitle: "Start Pos",
        tip: "Start Position",
        sType: "numeric",
      ...
      variantAllele: { sTitle: "Var", tip: "Variant Allele", sType: "string" },
      tumorFreq: {
        sTitle: "Allele Freq (T)",
    ...
    columnRender: {
      ...
      caseId: function(datum) {
        var mutation = datum.mutation;
        var caseIdFormat = MutationDetailsTableFormatter.getCaseId(
          mutation.get("caseId")
        );
        var vars = {};
        ...
        var templateFn = BackboneTemplateCache.getTemplateFn(
          "mutation_table_case_id_template"
        );
        return templateFn(vars);
      },
      proteinChange: function(datum) {
        ...
        if (_.isUndefined(mutation.get("proteinChange"))) {
          ...
          var proteinChange = MutationDetailsTableFormatter.getProteinChange(
            mutation
          );
          var vars = {};
          ...
          vars.pdbMatchLink = MutationDetailsTableFormatter.getPdbMatchLink(
            mutation
          );

          var templateFn = BackboneTemplateCache.getTemplateFn(
            "mutation_table_protein_change_template"
          );
          return templateFn(vars);
        }
      },
      cancerStudy: function(datum) {
        ...
        var templateFn = BackboneTemplateCache.getTemplateFn(
          "mutation_table_cancer_study_template"
        );
        return templateFn(vars);
      },
      tumorType: function(datum) {
        ...
        var templateFn = BackboneTemplateCache.getTemplateFn(
          "mutation_table_tumor_type_template"
        );
        return templateFn(vars);
      },
      mutationType: function(datum) {
        ...
        if (_.isUndefined(mutation.get("mutationType"))) {
          ...
          var templateFn = BackboneTemplateCache.getTemplateFn(
            "mutation_table_mutation_type_template"
          );
          return templateFn(vars);
        }
      },
      cosmic: function(datum) {
        var mutation = datum.mutation;
        var cosmic = MutationDetailsTableFormatter.getCosmic(
          mutation.getCosmicCount()
        );
        var vars = {};
        ...
        var templateFn = BackboneTemplateCache.getTemplateFn(
          "mutation_table_cosmic_template"
        );
        return templateFn(vars);
      },
      cna: function(datum) {
        ...
        var templateFn = BackboneTemplateCache.getTemplateFn(
          "mutation_table_cna_template"
        );
        return templateFn(vars);
      },
      mutationCount: function(datum) {
        var mutation = datum.mutation;
        var mutationCount = MutationDetailsTableFormatter.getIntValue(
          mutation.get("mutationCount")
        );
        var vars = {};
        ...
        var templateFn = BackboneTemplateCache.getTemplateFn(
          "mutation_table_mutation_count_template"
        );
        return templateFn(vars);
      },
      normalFreq: function(datum) {
        var mutation = datum.mutation;
        var alleleCount = MutationDetailsTableFormatter.getAlleleCount(
          mutation.get("normalAltCount")
        );
        var normalFreq = MutationDetailsTableFormatter.getAlleleFreq(
          mutation.get("normalFreq"),
          mutation.get("normalAltCount"),
        ...
        var templateFn = BackboneTemplateCache.getTemplateFn(
          "mutation_table_normal_freq_template"
        );
        return templateFn(vars);
      },
      tumorFreq: function(datum) {
        ...
        var tumorFreq = MutationDetailsTableFormatter.getAlleleFreq(
          mutation.get("tumorFreq"),
          mutation.get("tumorAltCount"),
        ...
        var templateFn = BackboneTemplateCache.getTemplateFn(
          "mutation_table_tumor_freq_template"
        );
        return templateFn(vars);
      },
      mutationAssessor: function(datum) {
        ...
        var templateFn = BackboneTemplateCache.getTemplateFn(
          "mutation_table_mutation_assessor_template"
        );
        return templateFn(vars);
      },
      mutationStatus: function(datum) {
        var mutation = datum.mutation;
        var mutationStatus = MutationDetailsTableFormatter.getMutationStatus(
          mutation.get("mutationStatus")
        );
        var vars = {};
        ...
        var templateFn = BackboneTemplateCache.getTemplateFn(
          "mutation_table_mutation_status_template"
        );
        return templateFn(vars);
      },
      validationStatus: function(datum) {
        var mutation = datum.mutation;
        var validationStatus = MutationDetailsTableFormatter.getValidationStatus(
          mutation.get("validationStatus")
        );
        var vars = {};
        ...
        var templateFn = BackboneTemplateCache.getTemplateFn(
          "mutation_table_validation_status_template"
        );
        return templateFn(vars);
      },
      normalRefCount: function(datum) {
        ...
        var templateFn = BackboneTemplateCache.getTemplateFn(
          "mutation_table_normal_ref_count_template"
        );
        return templateFn(vars);
      },
      normalAltCount: function(datum) {
        ...
        var templateFn = BackboneTemplateCache.getTemplateFn(
          "mutation_table_normal_alt_count_template"
        );
        return templateFn(vars);
      },
      tumorRefCount: function(datum) {
        ...
        var templateFn = BackboneTemplateCache.getTemplateFn(
          "mutation_table_tumor_ref_count_template"
        );
        return templateFn(vars);
      },
      tumorAltCount: function(datum) {
        ...
        var templateFn = BackboneTemplateCache.getTemplateFn(
          "mutation_table_tumor_alt_count_template"
        );
        return templateFn(vars);
      },
      startPos: function(datum) {
        ...
        if (_.isUndefined(mutation.get("startPos"))) {
          ...
          var startPos = MutationDetailsTableFormatter.getIntValue(
          ...
          var templateFn = BackboneTemplateCache.getTemplateFn(
            "mutation_table_start_pos_template"
          );
          return templateFn(vars);
        }
      },
      endPos: function(datum) {
        ...
        if (_.isUndefined(mutation.get("endPos"))) {
          ...
          var endPos = MutationDetailsTableFormatter.getIntValue(
            mutation.get("endPos")
          );
          var vars = {};
          ...
          var templateFn = BackboneTemplateCache.getTemplateFn(
            "mutation_table_end_pos_template"
          );
          return templateFn(vars);
        }
      },
      ...
      igvLink: function(datum) {
        ...
        var templateFn = BackboneTemplateCache.getTemplateFn(
          "mutation_table_igv_link_template"
        );
        return templateFn(vars);
      },
      cBioPortal: function(datum) {
        ...
        if (_.isUndefined(mutation.get("cBioPortal"))) {
          ...
          var portal = MutationDetailsTableFormatter.getCbioPortal(
            mutation.get("cBioPortal")
          );
          ...
          var templateFn = BackboneTemplateCache.getTemplateFn(
            "mutation_table_cbio_portal_template"
          );
          return templateFn(vars);
        }
      }
    ...
    columnTooltips: {
      ...
      cosmic: function(selector, helper) {
        ...
        $(selector)
          .find(".mutation_table_cosmic")
          .each(function() {
            var label = this;
            var mutationId = $(label)
              .closest("tr.mutation-table-data-row")
              .attr("id");
            ...
            qTipOptsCosmic.events = {
              render: function(event, api) {
                var model = {
                  cosmic: mutation.get("cosmic"),
                ...
                var cosmicView = new CosmicTipView({
                  el: container,
                  model: model
                });
                cosmicView.render();
            ...
            qTipOptsOma.events = {
              render: function(event, api) {
                ...
                var model = {
                  ...
                  xvia: mutation
                    .get("xVarLink")
                    .replace("getma.org", "mutationassessor.org/r2"),
                  msaLink: mutation
                    .get("msaLink")
                    .replace("getma.org", "mutationassessor.org/r2"),
                  pdbLink: mutation
                ...
                var fisTipView = new PredictedImpactTipView({
                  el: container,
                  model: model
                });
                fisTipView.render();
      ...
      cBioPortal: function(selector, helper) {
        ...
        var addTooltip = function(
          ...
          $(selector)
            .find(".mutation_table_cbio_portal")
            .each(function(idx, ele) {
              ...
              cbio.util.addTargetedQTip(ele, {
                ...
                events: {
                  render: function(event, api) {
                    var model = {
                      pancanMutationFreq: frequencies,
                    ...
                    var pancanTipView = new PancanMutationHistTipView({
                      el: container,
                      model: model
                    });
        ...
        if (mutationTable.getCustomData()["cBioPortal"] != null) {
          ...
          portalProxy.getPortalData(
            { cancerStudyMetaData: true, cancerStudyName: true },
            function(portalData) {
              addTooltip(
                mutationTable.getCustomData()["cBioPortal"],
    ...
    eventListeners: {
      ...
      proteinChange: function(dataTable, dispatcher, mutationUtil, gene) {
        ...
        $(dataTable)
          .find(".mutation-table-protein-change a")
          .off("click")
          .on("click", function(evt) {
            evt.preventDefault();
    ...
    dataTableOpts: {
      sDom:
        '<"H"<"mutation_datatables_filter"f>C<"mutation_datatables_info"i>>t<"F"<"mutation_datatables_download"T>>',
      bJQueryUI: true,
      bPaginate: false,
      ...
      oLanguage: {
        sInfo:
          "Showing _TOTAL_ mutation(s) in <span class='mutation-table-samples-info'></span> sample(s)",
  ...
  function initDataTableOpts(
    ...
    var columns = DataTableUtil.getColumnOptions(columnOpts, indexMap);
    ...
    var tableOpts = {
      ...
      aoColumnDefs: [
        ...
        { bSearchable: false, aTargets: nonSearchableCols }
      ],
      ...
      fnDrawCallback: function(oSettings) {
        ...
        if (_filterEventActive && _prevSearch != currSearch) {
          // trigger corresponding event
          _dispatcher.trigger(
            MutationDetailsEvents.MUTATION_TABLE_FILTERED,
            tableSelector
        ...
        var rowData = $(tableSelector)
          .DataTable()
          .rows({ filter: "applied" })
          .data();
        $(oSettings.nTableWrapper)
          .find(".mutation-table-samples-info")
          .text(_.size(uniqueSamples(rowData)));
        ...
        $(tableSelector)
          .find('span.mutation-table-additional-protein-change[alt=""]')
          .remove();
      },
      ...
      fnHeaderCallback: function(nHead, aData, iStart, iEnd, aiDisplay) {
        $(nHead)
          .find("th")
          .addClass("mutation-details-table-header");
  ...
  function requestColumnData(dataFnName, columnName, callback) {
    ...
    if (
      self._visiblityMap[columnName] === "excluded" ||
  ...
  function uniqueSamples(rowData) {
    ...
    _.each(rowData, function(data, index) {
      ...
      if (mutation && !_.isEmpty(mutation.get("caseId"))) {
...
function MutationDiagram(geneSymbol, options, data, dataProxies) {
  ...
  self.pileups =
    data == null
      ? null // current pileups (updated after each filtering)
...
MutationDiagram.prototype.defaultOpts = {
  ...
  lollipopFillColor: {
    // color of the lollipop data point
    missense: "#008000",
    truncating: "#000000",
    inframe: "#8B4513",
    fusion: "#8B00C9",
  ...
  xAxisTickIntervals: [
    // valid major tick intervals for x-axis
    100,
    200,
    400,
    500,
  ...
  yAxisTickIntervals: [
    // valid major tick intervals for y-axis
    1,
    2,
    5,
    10,
  ...
  regionTipFn: function(element, region, maProxy) {
    var model = {
      identifier: region.metadata.identifier,
      type: region.type,
    ...
    maProxy.getMutationAlignerData(
      ...
      function(data) {
        ...
        if (
          ...
          var templateFn = BackboneTemplateCache.getTemplateFn(
            "mutation_aligner_info_template"
          );
...
MutationDiagram.prototype.initDiagram = function() {
  ...
  self.drawDiagram(svg, bounds, self.options, self.data);
...
MutationDiagram.prototype.drawDiagram = function(svg, bounds, options, data) {
  ...
  self.drawPlot(svg, pileups, options, bounds, xScale, yScale);
...
MutationDiagram.prototype.calcYMax = function(options, maxCount) {
  return Math.min(options.maxLengthY, Math.max(maxCount, options.minLengthY));
};
 ...
 */
MutationDiagram.prototype.drawPlot = function(
  svg,
  pileups,
  options,
  bounds,
 ...
 */
MutationDiagram.prototype.calcTickInterval = function(
  intervals,
  maxValue,
  maxTickCount
) {
 ...
 */
MutationDiagram.prototype.drawXAxis = function(
  svg,
  xScale,
  xMax,
  options,
  ...
  var interval = self.calcTickInterval(
    options.xAxisTickIntervals,
    xMax,
    options.xAxisTicks
  );
 ...
 * @return {object} svg group containing all the axis components
 */
MutationDiagram.prototype.drawYAxis = function(
  svg,
  yScale,
  yMax,
  options,
 ...
 */
MutationDiagram.prototype.formatAxis = function(
  axisSelector,
  stroke,
  font,
  fontSize,
 ...
 */
MutationDiagram.prototype.drawLollipop = function(
  points,
  lines,
  pileup,
  options,
 ...
 * @param yScale        scale function for the y-axis
 */
MutationDiagram.prototype.drawLollipopLabels = function(
  labels,
  pileups,
  options,
  xScale,
  ...
  if (pileups.length > 1) {
    ...
    if (count < numberOfTies && numberOfTies > maxAllowedTie) {
      count = 0;
    }
  }

  // show (lollipopLabelCount) label(s)
  for (var i = 0; i < count && i < pileups.length; i++) {
    ...
    var y =
      yScale(Math.min(pileups[i].count, options.maxLengthY)) -
    ...
    var text = labels
      ...
      .attr(
        "transform",
        "rotate(" + options.lollipopTextAngle + ", " + x + "," + y + ")"
      )
 ...
 */
MutationDiagram.prototype.drawRegion = function(
  svg,
  region,
  options,
  bounds,
 ...
 */
MutationDiagram.prototype.drawRegionText = function(
  label,
  group,
  options,
  width
...
MutationDiagram.prototype.updatePlot = function(mutationColl) {
  ...
  if (mutationColl) {
    pileupData = PileupUtil.convertToPileups(
      mutationColl,
      self.options.pileupConverter
    );
  ...
  _.each(_.keys(self.listeners), function(selector) {
    ...
    _.each(_.keys(self.listeners[selector]), function(event) {
      target.on(event, self.listeners[selector][event]);
    });
  });
  ...
  // trigger corresponding event
  self.dispatcher.trigger(MutationDetailsEvents.DIAGRAM_PLOT_UPDATED);
...
MutationDiagram.prototype.resetPlot = function() {
  ...
  // trigger corresponding event
  self.dispatcher.trigger(MutationDetailsEvents.DIAGRAM_PLOT_RESET);
};
...
MutationDiagram.prototype.removeListener = function(selector, event) {
  ...
  if (self.listeners[selector] && self.listeners[selector][event]) {
...
MutationDiagram.prototype.addDefaultListeners = function() {
  ...
  self.addListener(".mut-dia-background", "click", function(datum, index) {
    ...
    var ignore = !self.isHighlighted() || self.multiSelect;
    ...
    if (!ignore) {
      ...
      // trigger corresponding event
      self.dispatcher.trigger(MutationDetailsEvents.ALL_LOLLIPOPS_DESELECTED);
    }
  });
...
MutationDiagram.prototype.isFiltered = function() {
  ...
  if (
    PileupUtil.countMutations(self.pileups) <
 ...
 * @override
 */
MutationHistogram.prototype.drawPlot = function(
  svg,
  pileups,
  options,
  bounds,
...
function MutationPdbPanel(options, data, proxy, xScale) {
  ...
  var _defaultOpts = {
    ...
    chainTipFn: function(element) {
      ...
      proxy.getPdbInfo(datum.pdbId, function(pdbInfo) {
        ...
        // init tip view
        var tipView = new PdbChainTipView({
          model: {
            pdbId: datum.pdbId,
    ...
    yHelpTipFn: function(element) {
      ...
      var options = {
        ...
        style: {
          classes:
            "qtip-light qtip-rounded qtip-shadow qtip-lightyellow qtip-wide"
        },
        position: { my: "bottom left", at: "top center", viewport: $(window) }
      };
    ...
    _.each(data, function(allocation, rowIdx) {
      _.each(allocation, function(datum, idx) {
        ...
        if (chain.alignments.length > 0) {
          ...
          var gChain = drawChainRectangles(
            svg,
            chain,
            color,
            options,
  ...
  function addChainTooltips(data, options) {
    ...
    _.each(data, function(allocation, rowIdx) {
      _.each(allocation, function(datum, idx) {
        ...
        chains.push(
          _chainMap[PdbDataUtil.chainKey(datum.pdbId, datum.chain.chainId)]
        );
      });
    });
  ...
  function xScaleFn(data) {
    var width = _options.elWidth - (_options.marginLeft + _options.marginRight);
  ...
  function init() {
    ...
    _maxExpansionLevel = calcMaxExpansionLevel(
      _rowData.length,
      _options.numRows
    );
    ...
    var svg = createSvg(container, _options.elWidth, _levelHeight);
  ...
  function removeListener(selector, event) {
    ...
    // remove listener from the map
    if (_listeners[selector] && _listeners[selector][event]) {
  ...
  function expandToLevel(level) {
    ...
    for (var i = _expansion; i < level && i < _maxExpansionLevel; i++) {
  ...
  function highlight(chainGroup) {
    ...
    // trigger corresponding event
    _dispatcher.trigger(MutationDetailsEvents.PANEL_CHAIN_SELECTED, chainGroup);
  }
  ...
  function fadeOutOthers(chainGroup, callback) {
    ...
    _svg
      .selectAll(".pdb-selection-rectangle-group")
      .transition()
      .duration(duration)
      .attr("opacity", function(datum) {
    ...
    _svg
      .select(".pdb-panel-y-axis-label-group")
      .transition()
      .duration(duration)
      .attr("opacity", 0)
      .each("end", function() {
  ...
  function fadeInAll(callback) {
    ...
    _svg
      .selectAll(".pdb-panel-y-axis-label-group")
      .transition()
      .duration(duration)
      .attr("opacity", 1)
      .each("end", function() {
...
function MutationPdbTable(options) {
  ...
  var _defaultOpts = {
    ...
    columns: {
      datum: { sTitle: "datum", tip: "" },
      pdbId: { sTitle: "PDB Id", tip: "", sType: "string" },
      chain: { sTitle: "Chain", tip: "", sType: "string" },
      uniprotPos: { sTitle: "Uniprot Positions", tip: "", sType: "numeric" },
      identityPercent: {
        sTitle: "Identity Percent",
        tip: "",
        sType: "numeric"
      },
      organism: { sTitle: "Organism", tip: "", sType: "string" },
      summary: { sTitle: "Summary", tip: "", sType: "string", sWidth: "65%" }
    },
    // display order of column headers
    columnOrder: [
      "datum",
    ...
    columnRender: {
      ...
      pdbId: function(datum) {
        ...
        var templateFn = BackboneTemplateCache.getTemplateFn(
          "mutation_pdb_table_pdb_cell_template"
        );
      ...
      chain: function(datum) {
        // format using the corresponding template
        var templateFn = BackboneTemplateCache.getTemplateFn(
          "mutation_pdb_table_chain_cell_template"
        );
      ...
      summary: function(datum) {
        var vars = {
          summary: datum.summary.title,
          molecule: datum.summary.molecule
        };

        // format using the corresponding template
        var templateFn = BackboneTemplateCache.getTemplateFn(
          "mutation_pdb_table_summary_cell_template"
        );
        return templateFn(vars);
      },
    ...
    eventListeners: {
      pdbLink: function(dataTable, dispatcher, indexMap) {
        $(dataTable).on("click", ".pbd-chain-table-chain-cell a", function(
          event
        ) {
          event.preventDefault();
    ...
    dataTableOpts: {
      ...
      sDom:
        '<"H"<"mutation_pdb_datatable_info"i><"mutation_pdb_datatable_filter"f>>t',
      bJQueryUI: true,
      bPaginate: false,
      bFilter: true,
      sScrollY: "200px",
  ...
  function initDataTableOpts(
    ...
    var tableOpts = {
      ...
      fnHeaderCallback: function(nHead, aData, iStart, iEnd, aiDisplay) {
        $(nHead)
          .find("th")
          .addClass("mutation-pdb-table-header");
      },
      fnRowCallback: function(nRow, aData, iDisplayIndex, iDisplayIndexFull) {
      ...
      fnInitComplete: function(oSettings, json) {
        // trigger corresponding event
        _dispatcher.trigger(MutationDetailsEvents.PDB_TABLE_READY);
      }
    };
...
function PancanMutationHistogram(
  byProteinPosData,
  byGeneData,
  ...
  var cancer_study2meta_data = generate_cancer_study2datum(
    cancer_study_meta_data
  );
  ...
  var keyword =
    bykeyword_data[0].hugo + " " + bykeyword_data[0].protein_pos_start;

  bykeyword_data = extend_by_zero_set(bykeyword_data).map(function(d) {
    d.keyword = keyword;
    return d;
  }); // make sure everything has a key.  TODO: remove this extra list traversal
  ...
  var commonKeys = _.intersection(
    _.keys(cancer_study2datum.bykeyword),
    _.keys(cancer_study2datum.bygene)
  );
  bykeyword_data = [];
  bygene_data = [];
  ...
  if (bygene_data.length !== all_cancer_studies.length) {
    throw new Error(
      "there must be a datum for every cancer study and visa versa"
    );
  }
  ...
  bygene_data.forEach(function(bygene_datum) {
    var bykeyword_datum =
      cancer_study2datum.bykeyword[bygene_datum.cancer_study];
    var new_count = bygene_datum.count - bykeyword_datum.count;

    if (new_count < 0) {
      throw new Error(
        "more mutations for a particular keyword than " +
  ...
  var totalSequenced = _.reduce(
    cancer_study2meta_data,
    function(memo, datum) {
      return memo + datum.num_sequenced_samples;
    },
    0
  );
  ...
  function compute_frequency(d) {
    var num_sequenced_samples =
      cancer_study2meta_data[d.cancer_study].num_sequenced_samples;
  ...
  function total_frequency(group) {
    var total_frequency = _.reduce(
      group,
      function(acc, next) {
        return acc + next.frequency;
      },
      0
    );
  ...
  function cancer_type(group) {
    ...
    if (
      !_.every(group, function(d) {
        return d.cancer_type === cancerType;
      })
    ) {
    ...
    function zero_datum(cancer_study) {
      return {
        ...
        num_sequenced_samples:
          cancer_study2meta_data[cancer_study].num_sequenced_samples
      };
    }
  ...
  var sparkline_y_threshold = 0.2;
  var yStackMax = params.sparkline
    ? sparkline_y_threshold
  ...
  if (params.sparkline) {
    return {
      el: el,
      qtip: function() {
        throw new Error("don't qtip a sparkline");
      }
    };
  }
  ...
  var percent_format = d3.format(yStackMax > 0.1 ? ".0%" : ".1%");
  var yAxis = d3.svg
    .axis()
    .scale(y)
  ...
  var hugo_gene_name = _.find(layers[0], function(d) {
    return d.hugo !== undefined;
  }).hugo;
  var keyword = _.find(layers[0], function(d) {
    return d.keyword !== undefined;
  }).keyword;
  ...
  function star_this_cancer_study() {
    ...
    try {
      ...
      throw new Error(
        e +
          ": could not find this the corresponding datum for this cancer study, [" +
          params.this_cancer_study +
          "]"
      );
    }
    ...
    this_cancer_type_group = _.find(
      this_cancer_type_group,
      find_this_cancer_studdy_datum
    );
  ...
  function qtip(svg) {
    ...
    mouseOverBar.each(function(d) {
      $(this).qtip({
        ...
        events: {
          render: function(event, api) {
            var data = getRectsByCancerStudy(d).map(function(rect) {
              return rect[0].__data__;
            });
            var bykeyword =
              data.filter(function(d) {
                return _.has(d, "keyword");
              })[0] || {};
            var bygene =
              data.filter(function(d) {
                return !_.has(d, "keyword");
  ...
  function qtip_template(d, total) {
    ...
    return _.template(
      "<span><b>{{percent}}</b> (<b>{{count}}</b> of {{total}} sequenced samples)</span>"
    )({ percent: percent, count: count, total: total });
  }
  ...
  function getRectsByCancerStudy(cancer_study) {
    return rect.filter(function(d) {
      return d.cancer_study === cancer_study;
    });
  }
  ...
  return {
    el: el,
    qtip: qtip,
    overallCountText: function() {
      return countText(
        { count: totalByKeyword },
        { count: totalByGene },
        totalSequenced
      );
    }
...
function MainMutationController(mainMutationView) {
  ...
  function diagramUpdateHandler() {
    if (_mutationDiagram && _mutationDiagram.isFiltered()) {
      // display info text
...
function Mutation3dController(
  ...
  function panelChainSelectHandler(element) {
    ...
    if (!_chainSelectedByTable && _pdbTableView != null) {
  ...
  function initPdbPanel(pdbColl) {
    ...
    if (_pdbPanelView == null) {
      _pdbPanelView = mainMutationView.initPdbPanelView(
        renderOptions.pdbPanel,
        viewOptions.pdbPanel,
        viewOptions.pdbTable,
        pdbColl
      );
  ...
  function initPdbTable(pdbColl) {
    ...
    if (_pdbTableView == null && _pdbPanelView != null && pdbColl.length > 0) {
      _pdbTableView = _pdbPanelView.initPdbTableView(pdbColl, function(
        view,
        table
      ) {
    ...
    if (_pdbPanelView != null && _pdbTableView != null) {
  ...
  function diagramDeselectHandler(datum, index) {
    ...
    if (_mutationDiagram && _mutationDiagram.isHighlighted()) {
  ...
  function reset3dView(pdbId, chainId) {
    ...
    if (mut3dView != null && _mut3dVisView != null) {
...
function MutationDetailsController(
  ...
  function initView(gene, cases, viewOptions) {
    ...
    mutationProxy.getMutationData(gene, function(data) {
      ...
      var uniprotInfo = mutationProxy
        .getMutationUtil()
        .dataFieldCount(gene, "uniprotAcc", ["NA"]);
      ...
      pfamProxy.getPfamData(servletParams, function(sequenceData) {
        ...
        dataManager.getData("variantAnnotation", { mutations: data }, function(
          params,
          data
        ) {
  ...
  function initComponents(
    ...
    function initDiagram() {
      if (diagramOpts && sequenceData) {
        diagramView = mainView.initMutationDiagramView(
          diagramOpts,
          sequenceData
        );
    ...
    if (vis3dOpts) {
      ...
      _3dController = new Mutation3dController(
        mutationDetailsView,
        mainView,
        viewOptions,
        renderOptions,
      ...
      if (renderOptions.mutationDetails.activate3dOnInit) {
        _3dController.reset3dView(
          renderOptions.mutationDetails.activate3dOnInit.pdbId,
  ...
  this.get3dController = function() {
    return _3dController;
  };
  this.get3dVisView = function() {
    return _mut3dVisView;
  };
  this.getMainViews = function() {
    return _geneTabView;
  };
  this.getDataManager = function() {
    return dataManager;
  };
  this.getDataProxies = function() {
    return dataProxies;
  };
}
...
function MutationDetailsTableController(mainMutationView, mutationDetailsView) {
  ...
  function allDeselectHandler() {
    if (mainMutationView.tableView) {
      ...
      mainMutationView.tableView.filter(
 ...
 * @author Selcuk Onur Sumer
 */
function MutationDiagramController(
  mutationDiagram,
  mutationTable,
  infoPanelView,
  mutationUtil
...
function MutationMapper(options) {
  ...
  function init() {
    ...
    _options.dataManager = jQuery.extend(true, {}, _options.dataManager, {
      dataProxies: dataProxies
    });
  ...
  this.getView = function() {
    return _mutationDetailsView;
  };
  this.getController = function() {
    return _mutationDetailsController;
  };
}
