  ...
  return (function e(t, n, r) {
  ...
  })(
    {
        ...
        function(_dereq_, module, exports) {
          ...
          CoSELayout.prototype.initParameters = function() {
            ...
            if (!this.isSubLayout) {
              ...
              this.springConstant = Layout.transform(
                layoutOptionsPack.springStrength,
                FDLayoutConstants.DEFAULT_SPRING_STRENGTH,
                5.0,
                5.0
              );
              this.repulsionConstant = Layout.transform(
                layoutOptionsPack.repulsionStrength,
                FDLayoutConstants.DEFAULT_REPULSION_STRENGTH,
                5.0,
                5.0
              );
              this.gravityConstant = Layout.transform(
                layoutOptionsPack.gravityStrength,
                FDLayoutConstants.DEFAULT_GRAVITY_STRENGTH
              );
              this.compoundGravityConstant = Layout.transform(
                layoutOptionsPack.compoundGravityStrength,
                FDLayoutConstants.DEFAULT_COMPOUND_GRAVITY_STRENGTH
              );
              this.gravityRangeFactor = Layout.transform(
                layoutOptionsPack.gravityRange,
                FDLayoutConstants.DEFAULT_GRAVITY_RANGE_FACTOR
              );
              this.compoundGravityRangeFactor = Layout.transform(
                layoutOptionsPack.compoundGravityRange,
          ...
          CoSELayout.prototype.classicLayout = function() {
            ...
            console.log(
              "Classic CoSE layout finished after " +
            ...
            do {
              ...
              if (
                ...
                this.coolingFactor =
                  ...
                  ((this.maxIterations - this.totalIterations) /
                    this.maxIterations);
                animationPeriod = Math.ceil(
                  initialAnimationPeriod * Math.sqrt(this.coolingFactor)
                );
              }
              ...
              this.animate();
              if (
                layoutOptionsPack.animate &&
                this.totalIterations % animationPeriod == 0
              ) {
                for (var i = 0; i < 1e7; i++) {
        ...
        function(_dereq_, module, exports) {
          ...
          function FDLayout() {
            ...
            this.displacementThresholdPerNode =
              (3.0 * FDLayoutConstants.DEFAULT_EDGE_LENGTH) / 100;
          ...
          FDLayout.prototype.calcRepulsionForce = function(nodeA, nodeB) {
            ...
            if (rectA.intersects(rectB)) {
              ...
              if (Math.abs(distanceX) < FDLayoutConstants.MIN_REPULSION_DIST) {
                distanceX =
                  IMath.sign(distanceX) * FDLayoutConstants.MIN_REPULSION_DIST;
              }

              if (Math.abs(distanceY) < FDLayoutConstants.MIN_REPULSION_DIST) {
                distanceY =
                  IMath.sign(distanceY) * FDLayoutConstants.MIN_REPULSION_DIST;
              }
          ...
          FDLayout.prototype.calcGravitationalForce = function(node) {
            ...
            if (node.getOwner() == this.graphManager.getRoot()) {
              ...
              estimatedSize = Math.floor(
                ownerGraph.getEstimatedSize() * this.compoundGravityRangeFactor
              );
      ...
      14: [
        function(_dereq_, module, exports) {
          ...
          IGeometry.calcSeparationAmount = function(
            ...
            IGeometry.decideDirectionsForOverlappingNodes(
              rectA,
              rectB,
              directions
            );
          ...
          IGeometry.getIntersection2 = function(rectA, rectB, result) {
            ...
            // line is horizontal
              ...
              if (p1x > p2x) {
                if (p1y > p2y) {
                  cardinalDirectionA = IGeometry.getCardinalDirection(
                    slopeA,
                    slopePrime,
                    4
                  );
                  cardinalDirectionB = IGeometry.getCardinalDirection(
                    slopeB,
                    slopePrime,
                    2
                  );
        ...
        function(_dereq_, module, exports) {
          ...
          LGraph.prototype.calcEstimatedSize = function() {
            ...
            if (size == 0) {
              ...
              this.estimatedSize = Math.floor(
                size / Math.sqrt(this.nodes.length)
              );
            }
            ...
            while (toBeVisited.length > 0) {
              ...
              for (var i = 0; i < s; i++) {
                ...
                if (
                  ...
                  toBeVisited = toBeVisited.concat(
                    currentNeighbor.withChildren()
                  );
                }
              }
            }
      ...
      21: [
        function(_dereq_, module, exports) {
          ...
          LNode.prototype.getOwner = function() {
            if (this.owner != null) {
              if (
                !(
                  this.owner == null || this.owner.getNodes().indexOf(this) > -1
                )
              ) {
                throw "assert failed";
              }
          ...
          LNode.prototype.getEdgeListToNode = function(to) {
            ...
            for (var obj in this.edges) {
              ...
              if (edge.target == to) {
                if (edge.source != this) throw "Incorrect edge source!";
          ...
          LNode.prototype.getNeighborsList = function() {
            ...
            for (var obj in this.edges) {
              ...
              if (edge.source == this) {
                ...
                if (!edge.target == this) throw "Incorrect incidency!";
          ...
          LNode.prototype.withChildren = function() {
            ...
            if (this.child != null) {
              ...
              for (var i = 0; i < nodes.length; i++) {
                ...
                withNeighborsList = withNeighborsList.concat(
                  childNode.withChildren()
                );
              }
            }
          ...
          LNode.prototype.calcEstimatedSize = function() {
            if (this.child == null) {
              return (this.estimatedSize = Math.floor(
        ...
        { "./Integer": 16, "./LGraphObject": 20, "./RectangleD": 27 }
      ],
      22: [
        function(_dereq_, module, exports) {
          var LayoutConstants = _dereq_("./LayoutConstants");
          ...
          Layout.prototype.runLayout = function() {
            ...
            if (
              ...
              if (!this.isSubLayout) {
                ...
                console.log(
                  "Total execution time: " + excTime + " miliseconds."
                );
              }
            }
          ...
          Layout.prototype.initParameters = function() {
            if (!this.isSubLayout) {
              ...
              this.animationPeriod = Math.floor(
                Layout.transform(
                  layoutOptionsPack.animationPeriod,
            ...
            while (unProcessedNodes.length > 0 && isForest) {
              ...
              while (toBeVisited.length > 0 && isForest) {
                ...
                for (var i = 0; i < neighborEdges.length; i++) {
                  var currentNeighbor = neighborEdges[i].getOtherEnd(
                    currentNode
                  );
        ...
        { "./HashMap": 12, "./LGraphManager": 19, "./LayoutConstants": 23 }
      ],
      23: [
        function(_dereq_, module, exports) {
          ...
          LayoutConstants.INITIAL_WORLD_BOUNDARY =
            LayoutConstants.WORLD_BOUNDARY / 1000;
      ...
      30: [
        function(_dereq_, module, exports) {
          ...
          layoutOptionsPack.defaultLayoutQuality =
            LayoutConstants.DEFAULT_QUALITY;
          layoutOptionsPack.defaultAnimationDuringLayout =
            LayoutConstants.DEFAULT_ANIMATION_DURING_LAYOUT;
          layoutOptionsPack.defaultAnimationOnLayout =
            LayoutConstants.DEFAULT_ANIMATION_ON_LAYOUT;
          layoutOptionsPack.defaultAnimationPeriod = 50;
          layoutOptionsPack.defaultIncremental =
            LayoutConstants.DEFAULT_INCREMENTAL;
          layoutOptionsPack.defaultCreateBendsAsNeeded =
            LayoutConstants.DEFAULT_CREATE_BENDS_AS_NEEDED;
          layoutOptionsPack.defaultUniformLeafNodeSizes =
            LayoutConstants.DEFAULT_UNIFORM_LEAF_NODE_SIZES;

          function setDefaultLayoutProperties() {
            layoutOptionsPack.layoutQuality =
              layoutOptionsPack.defaultLayoutQuality;
            layoutOptionsPack.animationDuringLayout =
              layoutOptionsPack.defaultAnimationDuringLayout;
            layoutOptionsPack.animationOnLayout =
              layoutOptionsPack.defaultAnimationOnLayout;
            layoutOptionsPack.animationPeriod =
              layoutOptionsPack.defaultAnimationPeriod;
            layoutOptionsPack.incremental =
              layoutOptionsPack.defaultIncremental;
            layoutOptionsPack.createBendsAsNeeded =
              layoutOptionsPack.defaultCreateBendsAsNeeded;
            layoutOptionsPack.uniformLeafNodeSizes =
              layoutOptionsPack.defaultUniformLeafNodeSizes;
          }
          ...
          function fillCoseLayoutOptionsPack() {
            layoutOptionsPack.defaultIdealEdgeLength =
              CoSEConstants.DEFAULT_EDGE_LENGTH;
            layoutOptionsPack.defaultSpringStrength = 50;
            layoutOptionsPack.defaultRepulsionStrength = 50;
            layoutOptionsPack.defaultSmartRepulsionRangeCalc =
              CoSEConstants.DEFAULT_USE_SMART_REPULSION_RANGE_CALCULATION;
            ...
            layoutOptionsPack.defaultSmartEdgeLengthCalc =
              CoSEConstants.DEFAULT_USE_SMART_IDEAL_EDGE_LENGTH_CALCULATION;
            layoutOptionsPack.defaultMultiLevelScaling =
              CoSEConstants.DEFAULT_USE_MULTI_LEVEL_SCALING;

            layoutOptionsPack.idealEdgeLength =
              layoutOptionsPack.defaultIdealEdgeLength;
            layoutOptionsPack.springStrength =
              layoutOptionsPack.defaultSpringStrength;
            layoutOptionsPack.repulsionStrength =
              layoutOptionsPack.defaultRepulsionStrength;
            layoutOptionsPack.smartRepulsionRangeCalc =
              layoutOptionsPack.defaultSmartRepulsionRangeCalc;
            layoutOptionsPack.gravityStrength =
              layoutOptionsPack.defaultGravityStrength;
            layoutOptionsPack.gravityRange =
              layoutOptionsPack.defaultGravityRange;
            layoutOptionsPack.compoundGravityStrength =
              layoutOptionsPack.defaultCompoundGravityStrength;
            layoutOptionsPack.compoundGravityRange =
              layoutOptionsPack.defaultCompoundGravityRange;
            layoutOptionsPack.smartEdgeLengthCalc =
              layoutOptionsPack.defaultSmartEdgeLengthCalc;
          ...
          _CoSELayout.prototype.run = function() {
            ...
            if (!this.options.tile) {
              ...
              var tiledZeroDegreeNodes = this.clearZeroDegreeMembers(
                memberGroups
              );
            }
            ...
            t1.pass(pData)
              .run(function(pData) {
                ...
                var processNodes = function(parent, children) {
                  ...
                  for (var i = 0; i < size; i++) {
                    ...
                    if (theChild.width != null && theChild.height != null) {
                      theNode = parent.add(
                        new CoSENode(
                          gm_t,
                          new PointD(theChild.x, theChild.y),
                          new DimensionD(
                            parseFloat(theChild.width),
                    ...
                    if (
                      ...
                      var theNewGraph;
                      theNewGraph = layout_t
                        .getGraphManager()
                        .add(layout_t.newGraph(), theNode);
              ...
              .then(function(pass) {
                ...
                if (after.options.fit)
                  after.options.cy.fit(
                    after.options.eles.nodes(),
                    after.options.padding
                  );
          ...
          _CoSELayout.prototype.groupZeroDegreeMembers = function() {
            ...
            var zeroDegree = this.options.eles.nodes().filter(function(i, ele) {
              if (
                self.getNodeDegreeWithChildren(ele) == 0 &&
                (ele.parent().length == 0 ||
                  (ele.parent().length > 0 &&
                    !self.getToBeTiled(ele.parent()[0])))
              )
                return true;
              else return false;
            });
            ...
            for (var p_id in tempMemberGroups) {
              if (tempMemberGroups[p_id].length > 1) {
                ...
                if (this.options.cy.getElementById(dummyCompoundId).empty()) {
                  ...
                  var dummy = this.options.cy.nodes()[
                    this.options.cy.nodes().length - 1
                  ];
                  ...
                  for (var i = 0; i < tempMemberGroups[p_id].length; i++) {
                    ...
                    this.options.cy.add({
                      group: "nodes",
                      data: {
                        parent: dummyCompoundId,
                        width: node.width(),
                        height: node.height()
                      }
                    });
                    var tempchild = this.options.cy.nodes()[
                      this.options.cy.nodes().length - 1
                    ];
                    tempchild.hide();
          ...
          _CoSELayout.prototype.fillCompexOrderByDFS = function(
            compoundOrder,
            children
          ) {
            for (var i = 0; i < children.length; i++) {
          ...
          _CoSELayout.prototype.clearCompounds = function(options) {
            ...
            this.processChildrenList(
              this.root,
              this.options.eles.nodes().orphans()
            );
            ...
            for (var i = 0; i < compoundOrder.length; i++) {
              ...
              childGraphMap[compoundOrder[i].id()] = compoundOrder[
                i
              ].children();
          ...
          _CoSELayout.prototype.clearZeroDegreeMembers = function(
            memberGroups
          ) {
          ...
          _CoSELayout.prototype.repopulateCompounds = function(
            tiledMemberPack
          ) {
            for (var i = _CoSELayout.compoundOrder.length - 1; i >= 0; i--) {
              ...
              var horizontalMargin = parseInt(
                _CoSELayout.compoundOrder[i].css("padding-left")
              );
              var verticalMargin = parseInt(
                _CoSELayout.compoundOrder[i].css("padding-top")
              );
          ...
          _CoSELayout.prototype.repopulateZeroDegreeMembers = function(
            tiledPack
          ) {
           ...
           */
          _CoSELayout.prototype.adjustLocations = function(
            organization,
            x,
            y,
          ...
          _CoSELayout.prototype.tileNodes = function(nodes) {
            var self = this;
            var verticalPadding =
              typeof self.options.tilingPaddingVertical === "function"
                ? self.options.tilingPaddingVertical.call()
                : self.options.tilingPaddingVertical;
            var horizontalPadding =
              typeof self.options.tilingPaddingHorizontal === "function"
                ? self.options.tilingPaddingHorizontal.call()
                : self.options.tilingPaddingHorizontal;
            var organization = {
              rows: [],
              rowWidth: [],
              rowHeight: [],
            ...
            for (var i = 0; i < layoutNodes.length; i++) {
              ...
              if (cyNode) {
                minWidth =
                  parseInt(cyNode.css("padding-left")) +
                  parseInt(cyNode.css("padding-right"));
              }
          ...
          _CoSELayout.prototype.insertNodeToRow = function(
            organization,
            node,
            rowIndex,
            minWidth
           ...
           */
          _CoSELayout.prototype.canAddHorizontal = function(
            organization,
            extraWidth,
            extraHeight
          ) {
          ...
          _CoSELayout.prototype.shiftToLastRow = function(organization) {
            ...
            if (
              ...
              organization.width =
                organization.rowWidth[this.getLongestRowIndex(organization)];
              ...
              var prevTotal =
                organization.rowHeight[longest] + organization.rowHeight[last];
          ...
          _CoSELayout.prototype.processChildrenList = function(
            ...
            for (var i = 0; i < size; i++) {
              ...
              if (theChild.width() != null && theChild.height() != null) {
                theNode = parent.add(
                  new CoSENode(
                    _CoSELayout.layout.graphManager,
              ...
              if (
                ...
                var theNewGraph;
                theNewGraph = _CoSELayout.layout
                  .getGraphManager()
                  .add(_CoSELayout.layout.newGraph(), theNode);
