...
cbio.download = (function() {
  ...
  function requestDownload(servletName, servletParams) {
    ...
    initDownloadFrame(function() {
      var targetWindow = cbio.util.getTargetWindow(
        "global_file_download_frame"
      );

      targetWindow.postMessage(
        { servletName: servletName, servletParams: servletParams },
        getOrigin()
      );
    });
  }
  ...
  function initDownloadFrame(callback) {
    var frame =
      '<iframe id="global_file_download_frame" ' +
  ...
  function initDownloadForm() {
    var form =
      '<form id="global_file_download_form"' +
