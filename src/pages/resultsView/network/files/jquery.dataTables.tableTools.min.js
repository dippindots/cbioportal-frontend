...
(function(n, k, q) {
  var p = function(m, p) {
    ...
    g.Client.prototype = {
      ...
      glue: function(a, b) {
        ...
        this.domElement.style.zIndex &&
          (c = parseInt(this.domElement.style.zIndex, 10) + 1);
        ...
        this.domElement &&
          ...
          (this.div.innerHTML = this.getHTML(d.width, d.height).replace(
            /&/g,
            "&amp;"
          )));
      },
    ...
    TableTools = function(a, b) {
      ...
      this.s = {
        that: this,
        dt: e.fn.dataTable.Api
          ? new e.fn.dataTable.Api(a).settings()[0]
          : a.fnSettings(),
        print: {
          saveStart: -1,
          saveLength: -1,
      ...
      this.s.dt.bJUI &&
        e.extend(!0, this.classes, TableTools.classes_themeroller);
    ...
    TableTools.prototype = {
      ...
      fnGetTitle: function(a) {
        var b = "";
        "undefined" != typeof a.sTitle && "" !== a.sTitle
          ? (b = a.sTitle)
          : ((a = k.getElementsByTagName("title")),
            0 < a.length && (b = a[0].innerHTML));
        return 4 > "¡".toString().length
        ...
        for (var c, d = 0, f = a.length; d < f; d++) {
          if ("string" == typeof a[d]) {
            ...
            if ("undefined" == typeof TableTools.BUTTONS[a[d].sExtends]) {
              alert(
                "TableTools: Warning - unknown button type: " + a[d].sExtends
              );
              continue;
            }
          ...
          (c = this._fnCreateButton(
            c,
            e(b).hasClass(this.classes.collection.container)
          )) && b.appendChild(c);
        }
      },
      _fnCreateButton: function(a, b) {
        ...
        if (a.sAction.match(/flash/)) {
          ...
          "text" == a.sAction
            ? this._fnTextConfig(c, a)
            : "div" == a.sAction
            ? this._fnTextConfig(c, a)
            : "collection" == a.sAction &&
              (this._fnTextConfig(c, a), this._fnCollectionConfig(c, a));
        if (-1 !== this.s.dt.iTabIndex)
          e(c)
            .attr("tabindex", this.s.dt.iTabIndex)
            .attr("aria-controls", this.s.dt.sTableId)
            .on("keyup.DTTT", function(a) {
              13 === a.keyCode &&
                (a.stopPropagation(), e(this).trigger("click"));
            })
      ...
      _fnButtonBase: function(a, b) {
        ...
        b
          ? ((c =
              a.sTag && "default" !== a.sTag
                ? a.sTag
                : this.s.tags.collection.button),
            (d =
              a.sLinerTag && "default" !== a.sLinerTag
                ? a.sLiner
                : this.s.tags.collection.liner),
            (f = this.classes.collection.buttons.normal))
          : ((c = a.sTag && "default" !== a.sTag ? a.sTag : this.s.tags.button),
            (d =
              a.sLinerTag && "default" !== a.sLinerTag
                ? a.sLiner
                : this.s.tags.liner),
        ...
        c.setAttribute(
          "id",
          "ToolTables_" + this.s.dt.sInstance + "_" + e.buttonCounter
        );
        c.appendChild(d);
      ...
      _fnCollectionHide: function(a, b) {
        !(null !== b && "collection" == b.sExtends) &&
          null !== this.dom.collection.collection &&
          (e(this.dom.collection.collection).animate(
            { opacity: 0 },
            500,
            function() {
              this.style.display = "none";
      ...
      _fnRowSelectConfig: function() {
        if (this.s.master) {
          ...
          "os" === this.s.select.type &&
            (e(b.nTBody).on("mousedown.DTTT_Select", "tr", function(a) {
              if (a.shiftKey)
                e(b.nTBody)
          ...
          e(b.nTBody).on(
            ...
            function(c) {
              ...
              if (
                d.parentNode == b.nTBody &&
                b.oInstance.fnGetData(d) !== null
              ) {
                if (f.type == "os")
                ...
                else if (a.fnIsSelected(d)) a._fnRowDeselect(d, c);
      ...
      _fnRowSelect: function(a, b) {
        ...
        if (
          null === this.s.select.preRowSelect ||
          this.s.select.preRowSelect.call(this, b, d, !0)
        ) {
          f = 0;
      ...
      _fnRowDeselect: function(a, b) {
        ...
        if (
          null === this.s.select.preRowSelect ||
          this.s.select.preRowSelect.call(this, b, d, !1)
        ) {
          f = 0;
          for (j = c.length; f < j; f++)
            (c[f]._DTTT_selected = !1),
              c[f].nTr && e(c[f].nTr).removeClass(this.classes.select.row);
          null !== this.s.select.postDeselected &&
            this.s.select.postDeselected.call(this, d);
      ...
      _fnTextConfig: function(a, b) {
        ...
        null !== b.fnSelect &&
          TableTools._fnEventListen(this, "select", function(d) {
      ...
      _fnHasFlash: function() {
        try {
          ...
          if (
            navigator.mimeTypes &&
            navigator.mimeTypes["application/x-shockwave-flash"] !== q &&
      ...
      _fnColumnTargets: function(a) {
        ...
        if ("function" == typeof a) {
          ...
          for (c = 0; c < d; c++) b.push(f[c].bVisible ? !0 : !1);
        else if ("hidden" == a)
          for (c = 0; c < d; c++) b.push(f[c].bVisible ? !1 : !0);
        else if ("sortable" == a)
          for (c = 0; c < d; c++) b.push(f[c].bSortable ? !0 : !1);
        else for (c = 0; c < d; c++) b.push(!0);
        return b;
      },
      ...
      _fnGetDataTablesData: function(a) {
        ...
        m = (d = "none" !== this.s.select.type && d && 0 !== f.length)
          ? f
          : p.Api
          ? new p.Api(g)
              .rows(a.oSelectorOpts)
              .indexes()
              .flatten()
              .toArray()
          : g.oInstance
        ...
        for (f = m.length; d < f; d++) {
          ...
          for (c = g.aoColumns.length; b < c; b++)
            n[b] &&
              ((h = g.oApi._fnGetCellData(g, m[d], b, "display")),
              a.fnCellRender
                ? (h = a.fnCellRender(h, b, k, m[d]) + "")
                : "string" == typeof h
                ? ((h = h.replace(/\n/g, " ")),
                  (h = h.replace(
                    /<img.*?\s+alt\s*=\s*(?:"([^"]+)"|'([^']+)'|([^\s>]+)).*?>/gi,
        ...
        if (a.bFooter && null !== g.nTFoot) {
          ...
          for (c = g.aoColumns.length; b < c; b++)
            n[b] &&
              null !== g.aoColumns[b].nTf &&
              ((h = g.aoColumns[b].nTf.innerHTML
                .replace(/\n/g, " ")
                .replace(/<.*?>/g, "")),
              (h = this._fnHtmlDecode(h)),
              j.push(this._fnBoundData(h, a.sFieldBoundary, l)));
        ...
        for (f in d)
          if ("i" != f && "t" != f && 1 == f.length)
            for (var g = 0, i = d[f].length; g < i; g++)
              this.dom.print.hidden.push({ node: d[f][g], display: "block" }),
    ...
    TableTools.fnGetInstance = function(a) {
      ...
      for (var b = 0, c = TableTools._aInstances.length; b < c; b++)
        if (
          TableTools._aInstances[b].s.master &&
    ...
    e.fn.dataTable.Api &&
      e.fn.dataTable.Api.register("tabletools()", function() {
        var a = null;
        0 < this.context.length &&
          (a = TableTools.fnGetInstance(this.context[0].nTable));
        return a;
      });
    ...
    "function" == typeof m.fn.dataTable &&
    "function" == typeof m.fn.dataTableExt.fnVersionCheck &&
    m.fn.dataTableExt.fnVersionCheck("1.9.0")
      ? m.fn.dataTableExt.aoFeatures.push({
          fnInit: function(a) {
            a = new TableTools(
              a.oInstance,
              "undefined" != typeof a.oInit.oTableTools
                ? a.oInit.oTableTools
                : {}
            );
  ...
  "function" === typeof define && define.amd
    ? define(["jquery", "datatables"], p)
    : "object" === typeof exports
    ? p(require("jquery"), require("datatables"))
    : jQuery &&
      !jQuery.fn.dataTable.TableTools &&
