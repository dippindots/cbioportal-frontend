...
!(function(a, b, c) {
  !(function(a) {
      ...
      (z.render = function(a) {
        ...
        return (
          ...
          (f.posClass = this._createPosClass(
            (this.position = { my: k.my, at: k.at }).my
          )),
      ...
      (z.disable = function(a) {
        return this.destroyed
          ...
          : ("toggle" === a
            ...
            this.rendered &&
              this.tooltip.toggleClass(ab, a).attr("aria-disabled", a),
            (this.disabled = !!a),
            this);
      }),
      (z.enable = function() {
      ...
      (z._assignEvents = function() {
        ...
        d.each(e.events, function(a, b) {
          ...
          ("" + e.hide.event).indexOf("unfocus") > -1 &&
            this._bind(j.closest("html"), ["mousedown", "touchstart"], function(
              a
            ) {
              var b = d(a.target),
                c =
    ...
    d.extend(v.prototype, {
      ...
      create: function() {
        var a = (this.corner =
          (ob || db.ie) && this._parseCorner(this.options.corner));
        return (
          ...
          ob
            ...
            : ((h = this._calculateTip(r)),
              (h =
                ...
                " xe"),
              (j[2] =
                l && /^(r|b)/i.test(b.string()) ? (8 === db.ie ? 2 : 1) : 0),
              o
                .css({
    ...
    (xb = function() {
      ...
      d.extend(D, y.defaults, {
        show: { modal: { on: E, effect: D, blur: D, stealfocus: D, escape: D } }
      }),
