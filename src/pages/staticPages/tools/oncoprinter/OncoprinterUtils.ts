        ...
        switch (lcType) {
          ...
          case "exp":
            if (lcAlteration === "up") {
              ...
              throw new Error(
                `${errorPrefix}Alteration "${alteration}" is not valid - it must be "UP" or "DOWN" if Type is "EXP"`
              );
            }
            break;
          case "prot":
            if (lcAlteration === "up") {
              ...
              throw new Error(
                `${errorPrefix}Alteration "${alteration}" is not valid - it must be "UP" or "DOWN" if Type is "PROT"`
              );
            }
            break;
          default:
